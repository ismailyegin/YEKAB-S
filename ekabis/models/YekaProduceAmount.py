...
class YekaProduceAmount(BaseModel):
    business = models.OneToOneField(YekaBusiness, on_delete=models.CASCADE) #iş planı
    yekabusinessblog = models.ForeignKey(YekaBusinessBlog, on_delete=models.CASCADE) #iş planına ait iş bloğu
