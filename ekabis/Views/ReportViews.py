...
def general_reporting_orcl(request):
    try:
        with connection.cursor() as cursor:
            ...
            sql += " firma.TAXNUMBER AS vergi_no , firma.TAXOFFICE AS vergi_dairesi ,sozlesme.date as sozlesme_tarih, baglanti_bol.NAME AS baglanti_bolgesi, yeka.DEFINITION AS yeka ,yarisma.ID AS yarisma_id ,firma.NAME AS firma , "
            ...
            sql += " WHERE yeka_business_block.STATUS= 3  and yeka.isDeleted=0"
