...
!function (t, e) {
    ...
    var o = i((function (t, e) {
        t.exports = function () {
            ...
            var gt, yt = /\d/, bt = /\d\d/, _t = /\d{3}/, wt = /\d{4}/, kt = /[+-]?\d{6}/, xt = /\d\d?/,
                Dt = /\d\d\d\d?/, St = /\d\d\d\d\d\d?/, Ct = /\d{1,3}/, Tt = /\d{1,4}/, Mt = /[+-]?\d{1,6}/, Ot = /\d+/,
                Et = /[+-]?\d+/, Pt = /Z|[+-]\d\d:?\d\d/gi, At = /Z|[+-]\d\d(?::?\d\d)?/gi, Lt = /[+-]?\d+(\.\d{1,3})?/,
            ...
            var Bt, Wt = 0, Vt = 1, Ut = 2, Xt = 3, qt = 4, Zt = 5, $t = 6, Kt = 7, Jt = 8;
            ...
            var ee = "January_February_March_April_May_June_July_August_September_October_November_December".split("_"),
                ie = "Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec".split("_"), ne = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,
                oe = It, re = It;
            ...
            function xe(t, e, i) {
                var n, o, r = we(t.year(), e, i), s = Math.floor((t.dayOfYear() - r - 1) / 7) + 1;
            ...
            var Ie = "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),
                Ne = "Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_"), Fe = "Su_Mo_Tu_We_Th_Fr_Sa".split("_"), Re = It, Ye = It,
                je = It;
            ...
            function mi(t, e) {
                if (null !== e) {
                    var i, n = ai;
                    if (e.abbr = t, null != li[t]) O("defineLocaleOverride", "use moment.updateLocale(localeName, config) to change an existing locale. moment.defineLocale(localeName, config) should only be used for creating a new locale See http://momentjs.com/guides/#/warnings/define-locale/ for more info."), n = li[t]._config; else if (null != e.parentLocale) if (null != li[e.parentLocale]) n = li[e.parentLocale]._config; else {
            ...
            var _i = /^\s*((?:[+-]\d{6}|\d{4})-(?:\d\d-\d\d|W\d\d-\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?::\d\d(?::\d\d(?:[.,]\d+)?)?)?)([+-]\d\d(?::?\d\d)?|\s*Z)?)?$/,
                ...
                Di = [["HH:mm:ss.SSSS", /\d\d:\d\d:\d\d\.\d+/], ["HH:mm:ss,SSSS", /\d\d:\d\d:\d\d,\d+/], ["HH:mm:ss", /\d\d:\d\d:\d\d/], ["HH:mm", /\d\d:\d\d/], ["HHmmss.SSSS", /\d\d\d\d\d\d\.\d+/], ["HHmmss,SSSS", /\d\d\d\d\d\d,\d+/], ["HHmmss", /\d\d\d\d\d\d/], ["HHmm", /\d\d\d\d/], ["HH", /\d\d/]],
                Si = /^\/?Date\((-?\d+)/i,
            ...
            function Mi(t) {
                var e, i, n, o, r, s, a = t._i, l = _i.exec(a) || wi.exec(a);
                if (l) {
                    for (g(t).iso = !0, e = 0, i = xi.length; e < i; e++) if (xi[e][1].exec(l[1])) {
                        o = xi[e][0], n = !1 !== xi[e][2];
                        break
                    }
                    if (null == o) return void (t._isValid = !1);
                    if (l[3]) {
                        for (e = 0, i = Di.length; e < i; e++) if (Di[e][1].exec(l[3])) {
                            r = (l[2] || " ") + Di[e][0];
                            break
                        }
            ...
            function Hi(t) {
                if (t._f !== o.ISO_8601) if (t._f !== o.RFC_2822) {
                    t._a = [], g(t).empty = !0;
                    var e, i, n, r, s, a, l = "" + t._i, h = l.length, u = 0;
            ...
            function Bi(t) {
                if (!t._d) {
                    var e = rt(t._i), i = void 0 === e.day ? e.date : e.day;
            ...
            function Vi(t) {
                var e = t._i, i = t._f;
                return t._locale = t._locale || gi(t._l), null === e || void 0 === i && "" === e ? b({nullInput: !0}) : ("string" == typeof e && (t._i = e = t._locale.preparse(e)), D(e) ? new x(bi(e)) : (c(e) ? t._d = e : s(i) ? Gi(t) : i ? Hi(t) : Ui(t), y(t) || (t._d = null), t))
            }
            ...
            function nn(t) {
                var e, i, n = !1;
                for (e in t) if (l(t, e) && (-1 === Bt.call(en, e) || null != t[e] && isNaN(t[e]))) return !1;
                for (i = 0; i < en.length; ++i) if (t[en[i]]) {
                    if (n) return !1;
            ...
            function sn(t) {
                var e = rt(t), i = e.year || 0, n = e.quarter || 0, o = e.month || 0, r = e.week || e.isoWeek || 0,
                    s = e.day || 0, a = e.hour || 0, l = e.minute || 0, h = e.second || 0, u = e.millisecond || 0;
            ...
            function hn(t, e, i) {
                var n, o = Math.min(t.length, e.length), r = Math.abs(t.length - e.length), s = 0;
            ...
            function Ln(t, e, i, n) {
                var r = e._milliseconds, s = ln(e._days), a = ln(e._months);
            ...
            var In = An(1, "add"), Nn = An(-1, "subtract");
            ...
            function Gn(t, e) {
                ...
                var i = t || qi(), n = pn(i, this).startOf("day"), r = o.calendarFormat(this, n) || "sameElse",
            ...
            var ho = 1e3, uo = 60 * ho, co = 60 * uo, po = 3506328 * co;
            ...
            function Eo(t, e, i) {
                ...
                for (t = t.toUpperCase(), n = 0, o = l.length; n < o; ++n) if (r = l[n].name.toUpperCase(), s = l[n].abbr.toUpperCase(), a = l[n].narrow.toUpperCase(), i) switch (e) {
                    case"N":
                    case"NN":
                    case"NNN":
                        if (s === t) return l[n];
            ...
            function No() {
                ...
                for (t = 0, e = r.length; t < e; ++t) if (i = r[t].since <= r[t].until ? 1 : -1, n = this.clone().startOf("day").valueOf(), r[t].since <= n && n <= r[t].until || r[t].until <= n && n <= r[t].since) return (this.year() - o(r[t].since).year()) * i + r[t].offset;
                return this.year()
            }
            ...
            function Jo(t, e, i, n, o) {
                var r = ke(t, e, i, n, o), s = _e(r.year, 0, r.dayOfYear);
            ...
            function vr(t, e, i, n) {
                ...
                var o, r = gi(), s = t ? r._week.dow : 0, a = [];
            ...
            var Ir = Lr("ms"), Nr = Lr("s"), Fr = Lr("m"), Rr = Lr("h"), Yr = Lr("d"), jr = Lr("w"), Hr = Lr("M"),
                zr = Lr("Q"), Gr = Lr("y");
            ...
            var Ur = Vr("milliseconds"), Xr = Vr("seconds"), qr = Vr("minutes"), Zr = Vr("hours"), $r = Vr("days"),
                Kr = Vr("months"), Jr = Vr("years");

            function Qr() {
                return ut(this.days() / 7)
            }

            var ts = Math.round, es = {ss: 44, s: 45, m: 45, h: 22, d: 26, w: null, M: 11};
            ...
            function ns(t, e, i, n) {
                var o = Mn(t).abs(), r = ts(o.as("s")), s = ts(o.as("m")), a = ts(o.as("h")), l = ts(o.as("d")),
                    h = ts(o.as("M")), u = ts(o.as("w")), d = ts(o.as("y")),
            ...
            function hs() {
                if (!this.isValid()) return this.localeData().invalidDate();
                var t, e, i, n, o, r, s, a, l = as(this._milliseconds) / 1e3, h = as(this._days), u = as(this._months),
                    d = this.asSeconds();
    ...
    i((function (t, e) {
        ...
        (function (t) {
            t.defineLocale("ja", {
                ...
                calendar: {
                    sameDay: "[今日] LT", nextDay: "[明日] LT", nextWeek: function (t) {
                        return t.week() !== this.week() ? "[来週]dddd LT" : "dddd LT"
                    }, lastDay: "[昨日] LT", lastWeek: function (t) {
    ...
    var r = Math.ceil, s = Math.floor, a = function (t) {
            ...
            return function (e, i) {
                var n, o, r = String(l(e)), s = a(i), h = r.length;
        ...
        }, u = {codeAt: h(!1), charAt: h(!0)}, d = function (t) {
        ...
        c = d("object" == typeof globalThis && globalThis) || d("object" == typeof window && window) || d("object" == typeof self && self) || d("object" == typeof e && e) || function () {
            return this
        }() || Function("return this")(), p = function (t) {
            try {
                return !!t()
            } catch (t) {
                return !0
        ...
        }, v = c.document, g = m(v) && m(v.createElement), y = function (t) {
            ...
            return t[e] = i, t
        }, C = "__core-js_shared__", T = c[C] || function (t, e) {
            try {
                S(c, t, e)
            } catch (i) {
                c[t] = e
            ...
            return e
        }(C, {}), M = Function.toString;
    "function" != typeof T.inspectSource && (T.inspectSource = function (t) {
        return M.call(t)
    });
    var O, E, P, A = T.inspectSource, L = c.WeakMap, I = "function" == typeof L && /native code/.test(A(L)),
        N = function (t) {
            return Object(l(t))
        }, F = {}.hasOwnProperty, R = Object.hasOwn || function (t, e) {
            return F.call(N(t), e)
        }, Y = i((function (t) {
            (t.exports = function (t, e) {
                return T[t] || (T[t] = void 0 !== e ? e : {})
            })("versions", []).push({version: "3.15.2", mode: "pure", copyright: "© 2021 Denis Pushkarev (zloirock.ru)"})
        })), j = 0, H = Math.random(), z = function (t) {
            return "Symbol(" + String(void 0 === t ? "" : t) + ")_" + (++j + H).toString(36)
        }, G = Y("keys"), B = function (t) {
            return G[t] || (G[t] = z(t))
        }, W = {}, V = "Object already initialized", U = c.WeakMap;
    if (I || T.state) {
        var X = T.state || (T.state = new U), q = X.get, Z = X.has, $ = X.set;
        O = function (t, e) {
    ...
    var J, Q, tt = {
        set: O, get: E, has: P, enforce: function (t) {
            return P(t) ? E(t) : O(t, {})
    ...
    }, et = {}.propertyIsEnumerable, it = Object.getOwnPropertyDescriptor, nt = {
        f: it && !et.call({1: 2}, 1) ? function (t) {
            var e = it(this, t);
            return !!e && e.enumerable
        } : et
    }, ot = {}.toString, rt = function (t) {
        return ot.call(t).slice(8, -1)
    }, st = "".split, at = p((function () {
        return !Object("z").propertyIsEnumerable(0)
    })) ? function (t) {
        return "String" == rt(t) ? st.call(t, "") : Object(t)
    } : Object, lt = function (t) {
        return at(l(t))
    }, ht = Object.getOwnPropertyDescriptor, ut = {
        f: f ? ht : function (t, e) {
        ...
        var i, n, o, r, s, a, l, h, u = t.target, d = t.global, p = t.stat, f = t.proto,
            m = d ? c : p ? c[u] : (c[u] || {}).prototype, v = d ? yt : yt[u] || (yt[u] = {}), g = v.prototype;
    ...
    })), St = B("IE_PROTO"), Ct = Object.prototype, Tt = Dt ? Object.getPrototypeOf : function (t) {
    ...
    }, Et = Ot("navigator", "userAgent") || "", Pt = c.process, At = Pt && Pt.versions, Lt = At && At.v8;
    Lt ? Q = (J = Lt.split("."))[0] < 4 ? 1 : J[0] + J[1] : Et && (!(J = Et.match(/Edge\/(\d+)/)) || J[1] >= 74) && (J = Et.match(/Chrome\/(\d+)/)) && (Q = J[1]);
    var It, Nt, Ft, Rt = Q && +Q, Yt = !!Object.getOwnPropertySymbols && !p((function () {
            var t = Symbol();
            return !String(t) || !(Object(t) instanceof Symbol) || !Symbol.sham && Rt && Rt < 41
        })), jt = Yt && !Symbol.sham && "symbol" == typeof Symbol.iterator, Ht = Y("wks"), zt = c.Symbol,
        Gt = jt ? zt : zt && zt.withoutSetter || z, Bt = function (t) {
    ...
    var Xt, qt = {IteratorPrototype: It, BUGGY_SAFARI_ITERATORS: Vt}, Zt = Math.min, $t = function (t) {
            return t > 0 ? Zt(a(t), 9007199254740991) : 0
        }, Kt = Math.max, Jt = Math.min, Qt = function (t, e) {
            var i = a(t);
            return i < 0 ? Kt(i + e, 0) : Jt(i, e)
        }, te = function (t) {
            return function (e, i, n) {
                var o, r = lt(e), s = $t(r.length), a = Qt(n, s);
                if (t && i != i) {
                    for (; s > a;) if ((o = r[a++]) != o) return !0
                } else for (; s > a; a++) if ((t || a in r) && r[a] === i) return t || a || 0;
                return !t && -1
            }
        }, ee = {includes: te(!0), indexOf: te(!1)}, ie = ee.indexOf, ne = function (t, e) {
            var i, n = lt(t), o = 0, r = [];
        ...
        re = Object.keys || function (t) {
            ...
            return t
        }, ae = Ot("document", "documentElement"), le = B("IE_PROTO"), he = function () {
        }, ue = function (t) {
    ...
    pe[Bt("toStringTag")] = "z";
    var fe = "[object z]" === String(pe), me = Bt("toStringTag"), ve = "Arguments" == rt(function () {
            return arguments
        }()), ge = fe ? rt : function (t) {
            var e, i, n;
        ...
        }, be = x.f, _e = Bt("toStringTag"), we = function (t, e, i, n) {
            if (t) {
                var o = i ? t : t.prototype;
                R(o, _e) || be(o, _e, {configurable: !0, value: e}), n && !fe && S(o, "toString", ye)
            }
        }, ke = {}, xe = qt.IteratorPrototype, De = function () {
            return this
        ...
        }() : void 0), Ce = function (t, e, i, n) {
            n && n.enumerable ? t[e] = i : S(t, e, i)
        }, Te = qt.IteratorPrototype, Me = qt.BUGGY_SAFARI_ITERATORS, Oe = Bt("iterator"), Ee = "keys", Pe = "values",
        Ae = "entries", Le = function () {
            return this
        }, Ie = function (t, e, i, n, o, r, s) {
            !function (t, e, i) {
                var n = e + " Iterator";
                t.prototype = ce(xe, {next: D(1, i)}), we(t, n, !1, !0), ke[n] = De
            }(i, e, n);
            var a, l, h, u = function (t) {
                ...
                }, d = e + " Iterator", c = !1, p = t.prototype, f = p[Oe] || p["@@iterator"] || o && p[o],
                m = !Me && f || u(o), v = "Array" == e && p.entries || f;
            if (v && (a = Tt(v.call(new t)), Te !== Object.prototype && a.next && (we(a, d, !0, !0), ke[d] = Le)), o == Pe && f && f.name !== Pe && (c = !0, m = function () {
                return f.call(this)
            }), s && p[Oe] !== m && S(p, Oe, m), ke[e] = m, o) if (l = {
                values: u(Pe),
                keys: r ? m : u(Ee),
                entries: u(Ae)
            }, s) for (h in l) (Me || c || !(h in p)) && Ce(p, h, l[h]); else xt({
                target: e,
                proto: !0,
                forced: Me || c
            }, l);
            return l
        }, Ne = u.charAt, Fe = "String Iterator", Re = tt.set, Ye = tt.getterFor(Fe);
    Ie(String, "String", (function (t) {
        Re(this, {type: Fe, string: String(t), index: 0})
    }), (function () {
        var t, e = Ye(this), i = e.string, n = e.index;
        return n >= i.length ? {value: void 0, done: !0} : (t = Ne(i, n), e.index += t.length, {value: t, done: !1})
    }));
    var je = function (t) {
        var e = t.return;
    ...
    }, ze = Bt("iterator"), Ge = Array.prototype, Be = function (t) {
        return void 0 !== t && (ke.Array === t || Ge[ze] === t)
    }, We = function (t, e, i) {
        var n = w(e);
        n in t ? x.f(t, n, D(0, i)) : t[n] = i
    }, Ve = Bt("iterator"), Ue = function (t) {
    ...
    xt({target: "Array", stat: !0, forced: Ke}, {
        from: function (t) {
            var e, i, n, o, r, s, a = N(t), l = "function" == typeof this ? this : Array, h = arguments.length,
                u = h > 1 ? arguments[1] : void 0, d = void 0 !== u, c = Ue(a), p = 0;
            if (d && (u = _t(u, h > 2 ? arguments[2] : void 0, 2)), null == c || l == Array && Be(c)) for (i = new l(e = $t(a.length)); e > p; p++) s = d ? u(a[p], p) : a[p], We(i, p, s); else for (r = (o = c.call(a)).next, i = new l; !(n = r.call(o)).done; p++) s = d ? He(o, u, [n.value, p], !0) : n.value, We(i, p, s);
            return i.length = p, i
        }
    });
    var Je = yt.Array.from, Qe = Je, ti = "Array Iterator", ei = tt.set, ii = tt.getterFor(ti);
    Ie(Array, "Array", (function (t, e) {
        ei(this, {type: ti, target: lt(t), index: 0, kind: e})
    }), (function () {
        var t = ii(this), e = t.target, i = t.kind, n = t.index++;
    ...
    for (var oi in {
        ...
        var ri = c[oi], si = ri && ri.prototype;
        si && ge(si) !== ni && S(si, ni, oi), ke[oi] = ke.Array
    }
    var ai = Ue, li = Array.isArray || function (t) {
            return "Array" == rt(t)
        }, hi = oe.concat("length", "prototype"), ui = {
        ...
        pi = "object" == typeof window && window && Object.getOwnPropertyNames ? Object.getOwnPropertyNames(window) : [],
        ...
        }, mi = {f: Object.getOwnPropertySymbols}, vi = {f: Bt}, gi = x.f, yi = function (t) {
            var e = yt.Symbol || (yt.Symbol = {});
            R(e, t) || gi(e, t, {value: vi.f(t)})
        }, bi = Bt("species"), _i = function (t, e) {
            var i;
        ...
        }, wi = [].push, ki = function (t) {
            var e = 1 == t, i = 2 == t, n = 3 == t, o = 4 == t, r = 6 == t, s = 7 == t, a = 5 == t || r;
            return function (l, h, u, d) {
                for (var c, p, f = N(l), m = at(f), v = _t(h, u, 3), g = $t(m.length), y = 0, b = d || _i, _ = e ? b(l, g) : i || s ? b(l, 0) : void 0; g > y; y++) if ((a || y in m) && (p = v(c = m[y], y, f), t)) if (e) _[y] = p; else if (p) switch (t) {
                    case 3:
                        return !0;
                    case 5:
                        return c;
            ...
            findIndex: ki(6),
            filterOut: ki(7)
        }, Di = xi.forEach, Si = B("hidden"), Ci = "Symbol", Ti = Bt("toPrimitive"), Mi = tt.set, Oi = tt.getterFor(Ci),
        Ei = Object.prototype, Pi = c.Symbol, Ai = Ot("JSON", "stringify"), Li = ut.f, Ii = x.f, Ni = fi.f, Fi = nt.f,
        Ri = Y("symbols"), Yi = Y("op-symbols"), ji = Y("string-to-symbol-registry"),
        Hi = Y("symbol-to-string-registry"), zi = Y("wks"), Gi = c.QObject,
        Bi = !Gi || !Gi.prototype || !Gi.prototype.findChild, Wi = f && p((function () {
            return 7 != ce(Ii({}, "a", {
                get: function () {
                    return Ii(this, "a", {value: 7}).a
                }
            })).a
        })) ? function (t, e, i) {
            var n = Li(Ei, e);
            ...
            return Mi(i, {type: Ci, tag: t, description: e}), f || (i.description = e), i
        }, Ui = jt ? function (t) {
            ...
            t === Ei && Xi(Yi, e, i), _(t);
            var n = w(e, !0);
            return _(i), R(Ri, n) ? (i.enumerable ? (R(t, Si) && t[Si][n] && (t[Si][n] = !1), i = ce(i, {enumerable: D(0, !1)})) : (R(t, Si) || Ii(t, Si, D(1, {})), t[Si][n] = !0), Wi(t, n, i)) : Ii(t, n, i)
        }, qi = function (t, e) {
            _(t);
            var i = lt(e), n = re(i).concat(Ji(i));
            return Di(n, (function (e) {
                f && !Zi.call(i, e) || Xi(t, e, i[e])
            })), t
        }, Zi = function (t) {
            var e = w(t, !0), i = Fi.call(this, e);
    ...
    if (Yt || (Ce((Pi = function () {
        ...
        return f && Bi && Wi(Ei, e, {configurable: !0, set: i}), Vi(e, t)
    ...
    })), xt({global: !0, wrap: !0, forced: !Yt, sham: !Yt}, {Symbol: Pi}), Di(re(zi), (function (t) {
        yi(t)
    })), xt({target: Ci, stat: !0, forced: !Yt}, {
        for: function (t) {
            var e = String(t);
    ...
    }), xt({target: "Object", stat: !0, forced: !Yt, sham: !f}, {
        create: function (t, e) {
            return void 0 === e ? ce(t) : qi(ce(t), e)
        }, defineProperty: Xi, defineProperties: qi, getOwnPropertyDescriptor: $i
    }), xt({target: "Object", stat: !0, forced: !Yt}, {
        ...
        var Qi = !Yt || p((function () {
            var t = Pi();
            return "[null]" != Ai([t]) || "{}" != Ai({a: t}) || "{}" != Ai(Object(t))
        }));
        xt({target: "JSON", stat: !0, forced: Qi}, {
    ...
    var tn = yt.Object.getOwnPropertySymbols, en = ut.f, nn = p((function () {
        en(1)
    }));
    xt({target: "Object", stat: !0, forced: !f || nn, sham: !f}, {
        getOwnPropertyDescriptor: function (t, e) {
            return en(lt(t), e)
        }
    });
    var on = i((function (t) {
        var e = yt.Object, i = t.exports = function (t, i) {
            return e.getOwnPropertyDescriptor(t, i)
        };
        e.getOwnPropertyDescriptor.sham && (i.sham = !0)
    })), rn = Ot("Reflect", "ownKeys") || function (t) {
        var e = ui.f(_(t)), i = mi.f;
        return i ? e.concat(i(t)) : e
    };
    xt({target: "Object", stat: !0, sham: !f}, {
    ...
    xt({target: "Object", stat: !0, forced: !f, sham: !f}, {defineProperties: se});
    var an = i((function (t) {
        var e = yt.Object, i = t.exports = function (t, i) {
    ...
    xt({target: "Object", stat: !0, forced: !f, sham: !f}, {defineProperty: x.f});
    var ln = i((function (t) {
        var e = yt.Object, i = t.exports = function (t, i, n) {
    ...
    function fn(t, e, i) {
        return e in t ? dn(t, e, {value: i, enumerable: !0, configurable: !0, writable: !0}) : t[e] = i, t
    }

    xt({target: "Array", stat: !0}, {isArray: li});
    var mn = yt.Array.isArray, vn = mn;
    var gn = Bt("species"), yn = function (t) {
        ...
        }, bn = Bt("isConcatSpreadable"), _n = 9007199254740991, wn = "Maximum allowed index exceeded",
        kn = Rt >= 51 || !p((function () {
            var t = [];
            return t[bn] = !1, t.concat()[0] !== t
        })), xn = yn("concat"), Dn = function (t) {
            if (!m(t)) return !1;
            var e = t[bn];
            return void 0 !== e ? !!e : li(t)
        };
    xt({target: "Array", proto: !0, forced: !kn || !xn}, {
        concat: function (t) {
            var e, i, n, o, r, s = N(this), a = _i(s, 0), l = 0;
            for (e = -1, n = arguments.length; e < n; e++) if (Dn(r = -1 === e ? s : arguments[e])) {
    ...
    var Cn = Sn;
    var Tn = yn("slice"), Mn = Bt("species"), On = [].slice, En = Math.max;
    xt({target: "Array", proto: !0, forced: !Tn}, {
        slice: function (t, e) {
            var i, n, o, r = lt(this), s = $t(r.length), a = Qt(t, s), l = Qt(void 0 === e ? s : e, s);
    ...
    }, An = Pn("Array").slice, Ln = Array.prototype, In = function (t) {
        var e = t.slice;
    ...
    var Wn = Sn, Vn = Pn("Array").concat, Un = Array.prototype, Xn = function (t) {
        var e = t.concat;
        return t === Un || t instanceof Array && e === Un.concat ? Vn : e
    }, qn = In;
    xt({target: "Reflect", stat: !0}, {ownKeys: rn});
    var Zn = yt.Reflect.ownKeys, $n = mn, Kn = xi.map, Jn = yn("map");
    xt({target: "Array", proto: !0, forced: !Jn}, {
        map: function (t) {
            return Kn(this, t, arguments.length > 1 ? arguments[1] : void 0)
        }
    });
    var Qn = Pn("Array").map, to = Array.prototype, eo = function (t) {
        var e = t.map;
        return t === to || t instanceof Array && e === to.map ? Qn : e
    }, io = p((function () {
        re(1)
    }));
    xt({target: "Object", stat: !0, forced: io}, {
        keys: function (t) {
            return re(N(t))
        }
    });
    ...
    var oo = yt.Date.now, ro = [].slice, so = {}, ao = function (t, e, i) {
        if (!(e in so)) {
        ...
        var e = bt(this), i = ro.call(arguments, 1), n = function () {
    ...
    xt({target: "Function", proto: !0}, {bind: lo});
    var ho = Pn("Function").bind, uo = Function.prototype, co = function (t) {
        var e = t.bind;
    ...
    }, fo = xi.forEach, mo = po("forEach") ? [].forEach : function (t) {
        return fo(this, t, arguments.length > 1 ? arguments[1] : void 0)
    };
    xt({target: "Array", proto: !0, forced: [].forEach != mo}, {forEach: mo});
    var vo = Pn("Array").forEach, go = Array.prototype, yo = {DOMTokenList: !0, NodeList: !0}, bo = function (t) {
        var e = t.forEach;
        return t === go || t instanceof Array && e === go.forEach || yo.hasOwnProperty(ge(t)) ? vo : e
    }, _o = [].reverse, wo = [1, 2];
    xt({target: "Array", proto: !0, forced: String(wo) === String(wo.reverse())}, {
        reverse: function () {
            return li(this) && (this.length = this.length), _o.call(this)
        }
    });
    var ko = Pn("Array").reverse, xo = Array.prototype, Do = function (t) {
        var e = t.reverse;
        return t === xo || t instanceof Array && e === xo.reverse ? ko : e
    }, So = yn("splice"), Co = Math.max, To = Math.min, Mo = 9007199254740991, Oo = "Maximum allowed length exceeded";
    xt({target: "Array", proto: !0, forced: !So}, {
        splice: function (t, e) {
            var i, n, o, r, s, l, h = N(this), u = $t(h.length), d = Qt(t, u), c = arguments.length;
            ...
            } else if (i > n) for (r = u - n; r > d; r--) l = r + i - 1, (s = r + n - 1) in h ? h[l] = h[s] : delete h[l];
            for (r = 0; r < i; r++) h[r + d] = arguments[r + 2];
            return h.length = u - n + i, o
        }
    });
    var Eo = Pn("Array").splice, Po = Array.prototype, Ao = function (t) {
        var e = t.splice;
        return t === Po || t instanceof Array && e === Po.splice ? Eo : e
    }, Lo = Object.assign, Io = Object.defineProperty, No = !Lo || p((function () {
        if (f && 1 !== Lo({b: 1}, Lo(Io({}, "a", {
            enumerable: !0, get: function () {
                Io(this, "b", {value: 3, enumerable: !1})
            }
        }), {b: 2})).b) return !0;
        ...
        for (var i = N(t), n = arguments.length, o = 1, r = mi.f, s = nt.f; n > o;) for (var a, l = at(arguments[o++]), h = r ? re(l).concat(r(l)) : re(l), u = h.length, d = 0; u > d;) a = h[d++], f && !s.call(l, a) || (i[a] = l[a]);
        return i
    } : Lo;
    xt({target: "Object", stat: !0, forced: Object.assign !== No}, {assign: No});
    var Fo = yt.Object.assign, Ro = ee.includes;
    xt({target: "Array", proto: !0}, {
        includes: function (t) {
            return Ro(this, t, arguments.length > 1 ? arguments[1] : void 0)
        }
    });
    var Yo = Pn("Array").includes, jo = Bt("match"), Ho = function (t) {
        if (function (t) {
            var e;
    ...
    var Go = Pn("String").includes, Bo = Array.prototype, Wo = String.prototype, Vo = function (t) {
        var e = t.includes;
        return t === Bo || t instanceof Array && e === Bo.includes ? Yo : "string" == typeof t || t === Wo || t instanceof String && e === Wo.includes ? Go : e
    }, Uo = p((function () {
        Tt(1)
    }));
    xt({target: "Object", stat: !0, forced: Uo, sham: !Dt}, {
        getPrototypeOf: function (t) {
            return Tt(N(t))
        }
    });
    var Xo = yt.Object.getPrototypeOf, qo = Xo, Zo = xi.filter, $o = yn("filter");
    xt({target: "Array", proto: !0, forced: !$o}, {
        filter: function (t) {
            return Zo(this, t, arguments.length > 1 ? arguments[1] : void 0)
        }
    });
    var Ko = Pn("Array").filter, Jo = Array.prototype, Qo = function (t) {
        var e = t.filter;
        return t === Jo || t instanceof Array && e === Jo.filter ? Ko : e
    }, tr = nt.f, er = function (t) {
        return function (e) {
            for (var i, n = lt(e), o = re(n), r = o.length, s = 0, a = []; r > s;) i = o[s++], f && !tr.call(n, i) || a.push(t ? [i, n[i]] : n[i]);
            return a
        }
    }, ir = {entries: er(!0), values: er(!1)}.values;
    xt({target: "Object", stat: !0}, {
        values: function (t) {
            return ir(t)
        }
    });
    var nr = yt.Object.values, or = "\t\n\v\f\r                　\u2028\u2029\ufeff", rr = "[" + or + "]",
        sr = RegExp("^" + rr + rr + "*"), ar = RegExp(rr + rr + "*$"), lr = function (t) {
            return function (e) {
                var i = String(l(e));
                return 1 & t && (i = i.replace(sr, "")), 2 & t && (i = i.replace(ar, "")), i
            }
        }, hr = {start: lr(1), end: lr(2), trim: lr(3)}, ur = hr.trim, dr = c.parseInt, cr = /^[+-]?0[Xx]/,
        pr = 8 !== dr(or + "08") || 22 !== dr(or + "0x16") ? function (t, e) {
            var i = ur(String(t));
            return dr(i, e >>> 0 || (cr.test(i) ? 16 : 10))
        } : dr;
    xt({global: !0, forced: parseInt != pr}, {parseInt: pr});
    var fr = yt.parseInt, mr = ee.indexOf, vr = [].indexOf, gr = !!vr && 1 / [1].indexOf(1, -0) < 0, yr = po("indexOf");
    xt({target: "Array", proto: !0, forced: gr || !yr}, {
        indexOf: function (t) {
            return gr ? vr.apply(this, arguments) || 0 : mr(this, t, arguments.length > 1 ? arguments[1] : void 0)
        }
    });
    var br, _r = Pn("Array").indexOf, wr = Array.prototype, kr = function (t) {
        var e = t.indexOf;
        return t === wr || t instanceof Array && e === wr.indexOf ? _r : e
    }, xr = hr.trim;
    xt({
        target: "String", proto: !0, forced: (br = "trim", p((function () {
    ...
    var Dr = Pn("String").trim, Sr = String.prototype, Cr = function (t) {
        var e = t.trim;
        return "string" == typeof t || t === Sr || t instanceof String && e === Sr.trim ? Dr : e
    };
    xt({target: "Object", stat: !0, sham: !f}, {create: ce});
    var Tr = yt.Object, Mr = function (t, e) {
            return Tr.create(t, e)
        }, Or = Mr, Er = Ot("JSON", "stringify"), Pr = /[\uD800-\uDFFF]/g, Ar = /^[\uD800-\uDBFF]$/,
        Lr = /^[\uDC00-\uDFFF]$/, Ir = function (t, e, i) {
            var n = i.charAt(e - 1), o = i.charAt(e + 1);
            return Ar.test(t) && !Lr.test(o) || Lr.test(t) && !Ar.test(n) ? "\\u" + t.charCodeAt(0).toString(16) : t
        }, Nr = p((function () {
            return '"\\udf06\\ud834"' !== Er("\udf06\ud834") || '"\\udead"' !== Er("\udead")
        }));
    Er && xt({target: "JSON", stat: !0, forced: Nr}, {
        stringify: function (t, e, i) {
            var n = Er.apply(null, arguments);
            return "string" == typeof n ? n.replace(Pr, Ir) : n
        }
    }), yt.JSON || (yt.JSON = {stringify: JSON.stringify});
    var Fr = function (t, e, i) {
        return yt.JSON.stringify.apply(null, arguments)
    }, Rr = [].slice, Yr = /MSIE .\./.test(Et), jr = function (t) {
        return function (e, i) {
            var n = arguments.length > 2, o = n ? Rr.call(arguments, 2) : void 0;
            return t(n ? function () {
                ("function" == typeof e ? e : Function(e)).apply(this, o)
            } : e, i)
        }
    };
    xt({global: !0, bind: !0, forced: Yr}, {setTimeout: jr(c.setTimeout), setInterval: jr(c.setInterval)});
    ...
    var zr = Pn("Array").fill, Gr = Array.prototype, Br = function (t) {
        var e = t.fill;
    ...
    var qr, Zr = "function" != typeof Object.assign ? function (t) {
            ...
            return e
        } : Object.assign, $r = ["", "webkit", "Moz", "MS", "ms", "o"],
        Kr = "undefined" == typeof document ? {style: {}} : document.createElement("div"), Jr = Math.round,
        Qr = Math.abs, ts = Date.now;
    ...
    var is = es(Kr.style, "touchAction"), ns = void 0 !== is;
    var os = "compute", rs = "auto", ss = "manipulation", as = "none", ls = "pan-x", hs = "pan-y", us = function () {
            if (!ns) return !1;
            var t = {}, e = qr.CSS && qr.CSS.supports;
            return ["auto", "manipulation", "pan-y", "pan-x", "pan-x pan-y", "none"].forEach((function (i) {
                return t[i] = !e || qr.CSS.supports("touch-action", i)
            })), t
        }(), ds = "ontouchstart" in qr, cs = void 0 !== es(qr, "PointerEvent"),
        ps = ds && /mobile|tablet|ip(ad|hone|od)|android/i.test(navigator.userAgent), fs = "touch", ms = "mouse",
        vs = 16, gs = 24, ys = ["x", "y"], bs = ["clientX", "clientY"];
    ...
    var xs = function () {
        ...
        return e.set = function (t) {
            ...
            if (this.manager.session.prevented) e.preventDefault(); else {
                var n = this.actions, o = ks(n, as) && !us.none, r = ks(n, hs) && !us["pan-y"],
                    s = ks(n, ls) && !us["pan-x"];
                if (o) {
    ...
    function Ss(t) {
        var e = t.length;
        if (1 === e) return {x: Jr(t[0].clientX), y: Jr(t[0].clientY)};
        for (var i = 0, n = 0, o = 0; o < e;) i += t[o].clientX, n += t[o].clientY, o++;
        return {x: Jr(i / e), y: Jr(n / e)}
    }
    ...
    function Cs(t) {
        ...
        return {timeStamp: ts(), pointers: e, center: Ss(e), deltaX: t.deltaX, deltaY: t.deltaY}
    }
    ...
    function Ps(t, e) {
        ...
        var r = i.firstInput, s = i.firstMultiple, a = s ? s.center : r.center, l = e.center = Ss(n);
        e.timeStamp = ts(), e.deltaTime = e.timeStamp - r.timeStamp, e.angle = Ms(a, l), e.distance = Ts(a, l), function (t, e) {
        ...
        e.overallVelocityX = d.x, e.overallVelocityY = d.y, e.overallVelocity = Qr(d.x) > Qr(d.y) ? d.x : d.y, e.scale = s ? (h = s.pointers, Ts((u = n)[0], u[1], bs) / Ts(h[0], h[1], bs)) : 1, e.rotation = s ? function (t, e) {
            ...
            if (8 !== e.eventType && (a > 25 || void 0 === s.velocity)) {
                var l = e.deltaX - s.deltaX, h = e.deltaY - s.deltaY, u = Es(a, l, h);
        ...
        var c, p = t.element, f = e.srcEvent;
        Ds(c = f.composedPath ? f.composedPath()[0] : f.path ? f.path[0] : f.target, p) && (p = c), e.target = p
    }

    function As(t, e, i) {
        var n = i.pointers.length, o = i.changedPointers.length, r = 1 & e && n - o == 0, s = 12 & e && n - o == 0;
    ...
    var js = {pointerdown: 1, pointermove: 2, pointerup: 4, pointercancel: 8, pointerout: 8},
        Hs = {2: fs, 3: "pen", 4: ms, 5: "kinect"}, zs = "pointerdown", Gs = "pointermove pointerup pointercancel";
    ...
    var Bs = function (t) {
        ...
        return Ur(e, t), e.prototype.handler = function (t) {
            var e = this.store, i = !1, n = t.type.toLowerCase().replace("ms", ""), o = js[n],
                r = Hs[t.pointerType] || t.pointerType, s = r === fs, a = Ys(e, t.pointerId, "pointerId");
    ...
    var Us = {touchstart: 1, touchmove: 2, touchend: 4, touchcancel: 8},
        Xs = "touchstart touchmove touchend touchcancel", qs = function (t) {
            function e() {
                var i;
            ...
            return Ur(e, t), e.prototype.handler = function (t) {
                var e = Us[t.type], i = Zs.call(this, t, e);
                i && this.callback(this.manager, e, {pointers: i[0], changedPointers: i[1], pointerType: fs, srcEvent: t})
            }, e
        }(Rs);

    function Zs(t, e) {
        var i, n, o = Ws(t.touches), r = this.targetIds;
        if (3 & e && 1 === o.length) return r[o[0].identifier] = !0, [o, o];
        var s = Ws(t.changedTouches), a = [], l = this.target;
        if (n = o.filter((function (t) {
            return Ds(t.target, l)
        })), 1 === e) for (i = 0; i < n.length;) r[n[i].identifier] = !0, i++;
    ...
    var $s = {mousedown: 1, mousemove: 2, mouseup: 4}, Ks = "mousedown", Js = "mousemove mouseup", Qs = function (t) {
        function e() {
            var i, n = e.prototype;
        ...
        return function (t) {
            function e(e, i) {
                ...
                return (n = t.call(this, e, i) || this).handler = function (t, e, i) {
                    var o = i.pointerType === fs, r = i.pointerType === ms;
                    if (!(r && i.sourceCapabilities && i.sourceCapabilities.firesTouchEvents)) {
                        if (o) ea.call(Xr(Xr(n)), e, i); else if (r && ia.call(Xr(Xr(n)), i)) return;
                        n.callback(t, e, i)
                    }
    ...
    var ha = function () {
        function t(t) {
            void 0 === t && (t = {}), this.options = Vr({enable: !0}, t), this.id = sa++, this.manager = null, this.state = 1, this.simultaneous = {}, this.requireFail = []
        }
        ...
        return i.getTouchAction = function () {
            ...
            var e = this, i = this.options, n = t.pointers.length === i.pointers, o = t.distance < i.threshold,
        ...
        function e(e) {
            return void 0 === e && (e = {}), t.call(this, Vr({pointers: 1}, e)) || this
        }
    ...
    var pa = function (t) {
            ...
            function e(e) {
                return void 0 === e && (e = {}), t.call(this, Vr({event: "pinch", threshold: 0, pointers: 2}, e)) || this
            }
            ...
            function e(e) {
                return void 0 === e && (e = {}), t.call(this, Vr({event: "rotate", threshold: 0, pointers: 2}, e)) || this
            }
            ...
            return i.getTouchAction = function () {
                ...
                var e = this, i = this.options, n = t.pointers.length === i.pointers, o = t.distance < i.threshold,
                    r = t.deltaTime > i.time;
                if (this._input = t, !o || !n || 12 & t.eventType && !r) this.reset(); else if (1 & t.eventType) this.reset(), this._timer = setTimeout((function () {
                    e.state = 8, e.tryEmit()
        ...
        ba = [[va, {enable: !1}], [ma, {enable: !1}, ["rotate"]], [fa, {direction: 6}], [pa, {direction: 6}, ["swipe"]], [ua], [ua, {
            event: "doubletap",
            taps: 2
        }, ["tap"]], [ga]];
    ...
    var wa = function () {
            ...
            return e.set = function (t) {
                ...
                var e = this.get(t);
                if (t) {
                    var i = this.recognizers, n = Ys(i, e);
        ...
        }(), ka = {touchstart: 1, touchmove: 2, touchend: 4, touchcancel: 8}, xa = "touchstart",
        Da = "touchstart touchmove touchend touchcancel", Sa = function (t) {
            function e() {
                var i, n = e.prototype;
    ...
    function Ca(t, e) {
        var i = Ws(t.touches), n = Ws(t.changedTouches);
    ...
    var Ma = Ta((function (t, e, i) {
        ...
        return t
    }), "extend", "Use `assign`."), Oa = Ta((function (t, e) {
        return Ma(t, e, !0)
    }), "merge", "Use `assign`.");
    ...
    function Ba(t) {
        var e = jn(function () {
            ...
            return [e, i, n]
        }(t), 3), i = e[0], n = e[1], o = e[2], r = 1, s = function () {
    ...
    var Va = "undefined" != typeof window ? window.Hammer || Aa : function () {
        return {
            on: t = function () {
            }, off: t, destroy: t, emit: t, get: function () {
                return {set: t}
            }
        };
        var t
    ...
    var Xa = /^\/?Date\((-?\d+)/i, qa = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i,
    ...
    function nl(t, e) {
        ...
        for (var o in e) if (Object.prototype.hasOwnProperty.call(e, o) || !0 === i) if ("object" === Gn(e[o]) && null !== e[o] && qo(e[o]) === Object.prototype) void 0 === t[o] ? t[o] = nl({}, e[o], i) : "object" === Gn(t[o]) && null !== t[o] && qo(t[o]) === Object.prototype ? nl(t[o], e[o], i) : el(t, e, o, n); else if ($n(e[o])) {
            var r;
            t[o] = qn(r = e[o]).call(r)
        } else el(t, e, o, n);
        return t
    ...
    function hl(t) {
        ...
        switch (t.length) {
            ...
            case 6:
            case 7:
                return (e = qa.exec(t)) ? {r: fr(e[1], 16), g: fr(e[2], 16), b: fr(e[3], 16)} : null;
            default:
                return null
        }
    }
    ...
    function dl(t, e, i) {
        t /= 255, e /= 255, i /= 255;
        var n = Math.min(t, Math.min(e, i)), o = Math.max(t, Math.max(e, i));
        return n === o ? {
            h: 0,
            s: 0,
            v: n
    ...
    var cl = function (t) {
        ...
        return bo(e = t.split(";")).call(e, (function (t) {
            if ("" != Cr(t).call(t)) {
                var e, n, o = t.split(":"), r = Cr(e = o[0]).call(e), s = Cr(n = o[1]).call(n);
                i[r] = s
            }
        })), i
    }, pl = function (t) {
    ...
    function fl(t, e, i) {
        var n, o, r, s = Math.floor(6 * t), a = 6 * t - s, l = i * (1 - e), h = i * (1 - a * e),
            u = i * (1 - (1 - a) * e);
        switch (s % 6) {
            case 0:
                n = i, o = u, r = l;
    ...
    var wl = {
        ...
        return pn(t, [{
            ...
            key: "_setColor", value: function (t) {
                ...
                var i = dl(t.r, t.g, t.b), n = 2 * Math.PI, o = this.r * i.s,
            ...
            key: "_updatePicker", value: function () {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this.color,
                    e = dl(t.r, t.g, t.b), i = this.colorPickerCanvas.getContext("2d");
                ...
                var n = this.colorPickerCanvas.clientWidth, o = this.colorPickerCanvas.clientHeight;
            ...
            key: "_bindHammer", value: function () {
                var t = this;
                this.drag = {}, this.pinch = {}, this.hammer = new Va(this.colorPickerCanvas), this.hammer.get("pinch").set({enable: !0}), this.hammer.on("hammer.input", (function (e) {
            ...
            key: "_generateHueCircle", value: function () {
                if (!1 === this.generated) {
                    ...
                    var a, l = 2 * Math.PI / 360, h = 1 / this.r;
                    for (n = 0; n < 360; n++) for (o = 0; o < this.r; o++) e = this.centerCoordinates.x + o * Math.sin(l * n), i = this.centerCoordinates.y + o * Math.cos(l * n), a = fl(.002777777777777778 * n, o * h, 1), t.fillStyle = "rgb(" + a.r + "," + a.g + "," + a.b + ")", t.fillRect(e - .5, i - .5, 2, 2);
            ...
            key: "_moveSelector", value: function (t) {
                var e = this.colorPickerDiv.getBoundingClientRect(), i = t.center.x - e.left, n = t.center.y - e.top,
                    o = .5 * this.colorPickerDiv.clientHeight, r = .5 * this.colorPickerDiv.clientWidth, s = i - r,
                    a = n - o, l = Math.atan2(s, a), h = .98 * Math.min(Math.sqrt(s * s + a * a), r),
                    u = Math.cos(l) * h + o, d = Math.sin(l) * h + r;
                ...
                var c = l / (2 * Math.PI);
                c = c < 0 ? c + 1 : c;
                var p = h / this.r, f = dl(this.color.r, this.color.g, this.color.b);
                f.h = c, f.s = p;
    ...
    var Dl, Sl = function () {
        ...
        return pn(t, [{
            key: "setOptions", value: function (t) {
                if (void 0 !== t) {
                    ...
                    var e = !0;
                    if ("string" == typeof t) this.options.filter = t; else if ($n(t)) this.options.filter = t.join(); else if ("object" === Gn(t)) {
            ...
            key: "_makeRange", value: function (t, e, i) {
                var n = t[0], o = t[1], r = t[2], s = t[3], a = document.createElement("input");
                ...
                var p = this._makeLabel(i[i.length - 1], i), f = this._makeItem(i, p, a, d);
            ...
            key: "_makeColorField", value: function (t, e, i) {
                var n = this, o = t[1], r = document.createElement("div");
            ...
            key: "_handleObject", value: function (t) {
                var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [],
                    i = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], n = !1, o = Qo(this.options),
                    r = !1;
                for (var s in t) if (Object.prototype.hasOwnProperty.call(t, s)) {
                    ...
                    if ("function" == typeof o && !1 === (n = o(s, e)) && !$n(a) && "string" != typeof a && "boolean" != typeof a && a instanceof Object && (this.allowCreation = !1, n = this._handleObject(a, l, !0), this.allowCreation = !1 === i), !1 !== n) {
                        ...
                        if ($n(a)) this._handleArray(a, h, l); else if ("string" == typeof a) this._makeTextInput(a, h, l); else if ("boolean" == typeof a) this._makeCheckbox(a, h, l); else if (a instanceof Object) {
                            if (!this.hideOption(e, s, this.moduleOptions)) if (void 0 !== a.enabled) {
                                var u = rl(l, "enabled"), d = this._getValue(u);
                                if (!0 === d) {
            ...
            key: "_constructOptions", value: function (t, e) {
                var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}, n = i;
    ...
    }(), Cl = !1, Tl = "background: #FFeeee; color: #dd0000", Ml = Ua, Ol = kl, El = Sl, Pl = Va, Al = function () {
        function t(e, i) {
        ...
        return pn(t, [{
            ...
            key: "show", value: function (t) {
                if (void 0 === t && (t = !0), !0 === t) {
                    var e = this.frame.clientHeight, i = this.frame.clientWidth, n = this.frame.parentNode.clientHeight,
                        o = this.frame.parentNode.clientWidth, r = 0, s = 0;
        ...
        return pn(t, null, [{
            key: "validate", value: function (e, i, n) {
                Cl = !1, Dl = i;
                var o = i;
            ...
            key: "getSuggestion", value: function (e, i, n) {
                var o, r = t.findInOptions(e, i, n, !1), s = t.findInOptions(e, Dl, [], !0);
            ...
            key: "findInOptions", value: function (e, i, n) {
                var o = arguments.length > 3 && void 0 !== arguments[3] && arguments[3], r = 1e9, s = "", a = [],
                    l = e.toLowerCase(), h = void 0;
                for (var u in i) {
                    var d = void 0;
                    if (void 0 !== i[u].__type__ && !0 === o) {
                        ...
                        var p;
                        -1 !== kr(p = u.toLowerCase()).call(p, l) && (h = u), r > (d = t.levenshteinDistance(e, u)) && (s = u, a = sl(n), r = d)
                    }
                }
        ...
        binarySearchCustom: function (t, e, i, n) {
            for (var o = 0, r = 0, s = t.length - 1; r <= s && o < 1e4;) {
                var a = Math.floor((r + s) / 2), l = t[a], h = e(void 0 === n ? l[i] : l[i][n]);
                if (0 == h) return a;
                -1 == h ? r = a + 1 : s = a - 1, o++
            }
            return -1
        ...
        binarySearchValue: function (t, e, i, n, o) {
            var r, s, a, l, h = 0, u = 0, d = t.length - 1;
        ...
        fillIfDefined: function t(e, i) {
            ...
            for (var o in e) if (void 0 !== i[o]) if (null === i[o] || "object" !== Gn(i[o])) el(e, i, o, n); else {
                var r = e[o], s = i[o];
                tl(r) && tl(s) && t(r, s, n)
            }
        },
        forEach: function (t, e) {
            if ($n(t)) for (var i = t.length, n = 0; n < i; n++) e(t[n], n, t); else for (var o in t) Object.prototype.hasOwnProperty.call(t, o) && e(t[o], o, t)
        },
        ...
        getTarget: function () {
            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : window.event, e = null;
        ...
        mergeOptions: function (t, e, i) {
            ...
            }, l = e[i], h = r(n) && !s(n), u = h ? n[i] : void 0, d = u ? u.enabled : void 0;
            if (void 0 !== l) {
        ...
        parseColor: function (t, e) {
            if (Qa(t)) {
                ...
                if (!0 === gl(i)) {
                    var r = vl(i), s = {h: r.h, s: .8 * r.s, v: Math.min(1, 1.02 * r.v)},
                        a = {h: r.h, s: Math.min(1, 1.25 * r.s), v: .8 * r.v}, l = ml(a.h, a.s, a.v),
                        h = ml(s.h, s.s, s.v);
                    return {
                        background: i,
                        border: l,
        ...
        removeCssText: function (t, e) {
            var i = cl(t.style.cssText), n = cl(e);
        ...
        selectiveDeepExtend: function (t, e, i) {
            ...
            for (var o = 0; o < t.length; o++) {
                var r = t[o];
                if (Object.prototype.hasOwnProperty.call(i, r)) if (i[r] && i[r].constructor === Object) void 0 === e[r] && (e[r] = {}), e[r].constructor === Object ? nl(e[r], i[r], !1, n) : el(e, i, r, n); else {
        ...
        selectiveNotDeepExtend: function (t, e, i) {
            var n = arguments.length > 3 && void 0 !== arguments[3] && arguments[3];
            if ($n(i)) throw new TypeError("Arrays are not supported by deepExtend");
            for (var o in i) if (Object.prototype.hasOwnProperty.call(i, o) && !Vo(t).call(t, o)) if (i[o] && i[o].constructor === Object) void 0 === e[o] && (e[o] = {}), e[o].constructor === Object ? nl(e[o], i[o]) : el(e, i, o, n); else if ($n(i[o])) {
                e[o] = [];
    ...
    }), Wl = Ot("Reflect", "construct"), Vl = p((function () {
        function t() {
        }
    ...
    xt({target: "Reflect", stat: !0, forced: Xl, sham: Xl}, {
        construct: function (t, e) {
            ...
            var o = i.prototype, r = ce(m(o) ? o : Object.prototype), s = Function.apply.call(t, r, e);
            return m(s) ? s : r
        }
    });
    ...
    var $l = Mr;
    xt({target: "Object", stat: !0}, {setPrototypeOf: Se});
    ...
    function Ql(t, e) {
        ...
        t.prototype = $l(e && e.prototype, {constructor: {value: t, writable: !0, configurable: !0}}), e && Jl(t, e)
    }
    ...
    var nh = i((function (t) {
        var e = function (t) {
            var e, i = Object.prototype, n = i.hasOwnProperty, o = "function" == typeof Symbol ? Symbol : {},
                r = o.iterator || "@@iterator", s = o.asyncIterator || "@@asyncIterator",
            ...
            function h(t, e, i, n) {
                var o = e && e.prototype instanceof v ? e : v, r = Object.create(o.prototype), s = new M(n || []);
            ...
            t.wrap = h;
            var d = "suspendedStart", c = "suspendedYield", p = "executing", f = "completed", m = {};
            ...
            var _ = Object.getPrototypeOf, w = _ && _(_(O([])));
            ...
            return g.prototype = k.constructor = y, y.constructor = g, g.displayName = l(y, a, "GeneratorFunction"), t.isGeneratorFunction = function (t) {
                ...
                constructor: M, reset: function (t) {
                    if (this.prev = 0, this.next = 0, this.sent = this._sent = e, this.done = !1, this.delegate = null, this.method = "next", this.arg = e, this.tryEntries.forEach(T), !t) for (var i in this) "t" === i.charAt(0) && n.call(this, i) && !isNaN(+i.slice(1)) && (this[i] = e)
                }, stop: function () {
                    this.done = !0;
                    ...
                    for (var r = this.tryEntries.length - 1; r >= 0; --r) {
                        ...
                        if (s.tryLoc <= this.prev) {
                            var l = n.call(s, "catchLoc"), h = n.call(s, "finallyLoc");
                            if (l && h) {
        ...
        return function (e, i, n, o) {
            bt(i);
            var r = N(e), s = at(r), a = $t(r.length), l = t ? a - 1 : 0, h = t ? -1 : 1;
            if (n < 2) for (; ;) {
                if (l in s) {
                    o = s[l], l += h;
                    break
    ...
    }, rh = {left: oh(!1), right: oh(!0)}, sh = "process" == rt(c.process), ah = rh.left, lh = po("reduce");
    xt({target: "Array", proto: !0, forced: !lh || !sh && Rt > 79 && Rt < 83}, {
        reduce: function (t) {
            return ah(this, t, arguments.length, arguments.length > 1 ? arguments[1] : void 0)
        }
    });
    var hh = Pn("Array").reduce, uh = Array.prototype, dh = function (t) {
        var e = t.reduce;
        return t === uh || t instanceof Array && e === uh.reduce ? hh : e
    }, ch = function (t, e, i, n, o, r, s, a) {
        for (var l, h = o, u = 0, d = !!s && _t(s, a, 3); u < n;) {
            if (u in i) {
                if (l = d ? d(i[u], u, e) : i[u], r > 0 && li(l)) h = ch(t, e, l, $t(l.length), h, r - 1) - 1; else {
    ...
    var fh = Pn("Array").flatMap, mh = Array.prototype, vh = function (t) {
        ...
        var n, o, r, s, a, l, h, u = i && i.that, d = !(!i || !i.AS_ENTRIES), c = !(!i || !i.IS_ITERATOR),
            p = !(!i || !i.INTERRUPTED), f = _t(e, u, 1 + d + p), m = function (t) {
        ...
        if (c) n = t; else {
            ...
            if (Be(o)) {
                for (r = 0, s = $t(t.length); s > r; r++) if ((a = v(t[r])) && a instanceof _h) return a;
                return new _h(!1)
            }
            n = o.call(t)
        }
        ...
        return t
    }, xh = x.f, Dh = xi.forEach, Sh = tt.set, Ch = tt.getterFor, Th = function (t, e, i) {
        var n, o = -1 !== t.indexOf("Map"), r = -1 !== t.indexOf("Weak"), s = o ? "set" : "add", a = c[t],
            l = a && a.prototype, h = {};
        if (f && "function" == typeof a && (r || l.forEach && !p((function () {
            (new a).entries().next()
        })))) {
            n = e((function (e, i) {
                Sh(kh(e, n, t), {type: t, collection: new a}), null != i && wh(i, e[s], {that: e, AS_ENTRIES: o})
            }));
            var u = Ch(t);
        ...
        return we(n, t, !1, !0), h[t] = n, xt({global: !0, forced: !0}, h), r || i.setStrong(n, t, o), n
    }, Mh = function (t, e, i) {
        for (var n in e) i && i.unsafe && t[n] ? t[n] = e[n] : Ce(t, n, e[n], i);
        return t
    }, Oh = Bt("species"), Eh = x.f, Ph = bh.fastKey, Ah = tt.set, Lh = tt.getterFor, Ih = {
        getConstructor: function (t, e, i, n) {
            var o = t((function (t, r) {
                kh(t, o, e), Ah(t, {
                    ...
                    last: void 0,
                    size: 0
                }), f || (t.size = 0), null != r && wh(r, t[n], {that: t, AS_ENTRIES: i})
            })), r = Lh(e), s = function (t, e, i) {
                var n, o, s = r(t), l = a(t, e);
            ...
            return Mh(o.prototype, {
                clear: function () {
                    ...
                    var e = this, i = r(e), n = a(e, t);
                    if (n) {
                        var o = n.next, s = n.previous;
                        delete i.index[n.index], n.removed = !0, s && (s.next = o), o && (o.previous = s), i.first == n && (i.first = o), i.last == n && (i.last = s), f ? i.size-- : e.size--
                    }
                    return !!n
                }, forEach: function (t) {
                    for (var e, i = r(this), n = _t(t, arguments.length > 1 ? arguments[1] : void 0, 3); e = e ? e.next : i.first;) for (n(e.value, e.key, this); e && e.removed;) e = e.previous
                }, has: function (t) {
                    return !!a(this, t)
                }
            }), Mh(o.prototype, i ? {
    ...
    var Fh = yt.Set, Rh = function (t) {
            var e = Ue(t);
            if ("function" != typeof e) throw TypeError(String(t) + " is not iterable");
            return _(e.call(t))
        }, Yh = Math.floor, jh = function (t, e) {
            var i = t.length, n = Yh(i / 2);
            ...
            return a
        }, Gh = jh, Bh = Et.match(/firefox\/(\d+)/i), Wh = !!Bh && +Bh[1], Vh = /MSIE|Trident/.test(Et),
        Uh = Et.match(/AppleWebKit\/(\d+)\./), Xh = !!Uh && +Uh[1], qh = [], Zh = qh.sort, $h = p((function () {
            qh.sort(void 0)
        })), Kh = p((function () {
            qh.sort(null)
        })), Jh = po("sort"), Qh = !p((function () {
            if (Rt) return Rt < 70;
            if (!(Wh && Wh > 3)) {
                if (Vh) return !0;
                if (Xh) return Xh < 603;
                ...
                for (t = 65; t < 76; t++) {
                    ...
                    for (n = 0; n < 47; n++) qh.push({k: e + n, v: i})
                }
    ...
    xt({target: "Array", proto: !0, forced: $h || !Kh || !Jh || !Qh}, {
        sort: function (t) {
            void 0 !== t && bt(t);
            var e = N(this);
            if (Qh) return void 0 === t ? Zh.call(e) : Zh.call(e, t);
            var i, n, o = [], r = $t(e.length);
    ...
    var tu = Pn("Array").sort, eu = Array.prototype, iu = function (t) {
        var e = t.sort;
        return t === eu || t instanceof Array && e === eu.sort ? tu : e
    }, nu = xi.some, ou = po("some");
    xt({target: "Array", proto: !0, forced: !ou}, {
        some: function (t) {
            return nu(this, t, arguments.length > 1 ? arguments[1] : void 0)
        }
    });
    var ru = Pn("Array").some, su = Array.prototype, au = function (t) {
            var e = t.some;
            return t === su || t instanceof Array && e === su.some ? ru : e
        }, lu = Pn("Array").keys, hu = Array.prototype, uu = {DOMTokenList: !0, NodeList: !0}, du = function (t) {
            var e = t.keys;
            return t === hu || t instanceof Array && e === hu.keys || uu.hasOwnProperty(ge(t)) ? lu : e
        }, cu = Pn("Array").values, pu = Array.prototype, fu = {DOMTokenList: !0, NodeList: !0}, mu = function (t) {
            var e = t.values;
            return t === pu || t instanceof Array && e === pu.values || fu.hasOwnProperty(ge(t)) ? cu : e
        }, vu = Pn("Array").entries, gu = Array.prototype, yu = {DOMTokenList: !0, NodeList: !0}, bu = function (t) {
            var e = t.entries;
    ...
    function Mu(t) {
        var e = function () {
            ...
            try {
                return Boolean.prototype.valueOf.call(ql(Boolean, [], (function () {
                }))), !0
            } catch (t) {
                return !1
            }
    ...
    var Nu = function () {
        ...
        return pn(t, [{
            key: "_trigger", value: function (t, e, i) {
                var n, o;
        ...
        return pn(t, [{
            key: gh, value: nh.mark((function t() {
                var e, i, n, o, r;
            ...
            key: "entries", value: nh.mark((function t() {
                var e, i, n, o, r;
                return nh.wrap((function (t) {
                    for (; ;) switch (t.prev = t.next) {
                        case 0:
            ...
            key: "keys", value: nh.mark((function t() {
                var e, i, n, o;
                return nh.wrap((function (t) {
                    for (; ;) switch (t.prev = t.next) {
                        case 0:
            ...
            key: "values", value: nh.mark((function t() {
                var e, i, n, o;
                return nh.wrap((function (t) {
                    for (; ;) switch (t.prev = t.next) {
                        case 0:
            ...
            key: "toObjectMap", value: function () {
                var t, e = Or(null), i = Ou(this._pairs);
                try {
                    for (i.s(); !(t = i.n()).done;) {
                        var n = jn(t.value, 2), o = n[0], r = n[1];
                        e[o] = r
                    }
                } catch (t) {
                    i.e(t)
            ...
            key: "distinct", value: function (t) {
                var e, i = new Fh, n = Ou(this._pairs);
                try {
                    for (n.s(); !(e = n.n()).done;) {
                        var o = jn(e.value, 2), r = o[0], s = o[1];
                        i.add(t(s, r))
                    }
                } catch (t) {
                    n.e(t)
            ...
            key: "max", value: function (t) {
                var e = Rh(this._pairs), i = e.next();
                if (i.done) return null;
                for (var n = i.value[1], o = t(i.value[1], i.value[0]); !(i = e.next()).done;) {
                    var r = jn(i.value, 2), s = r[0], a = r[1], l = t(a, s);
                    l > o && (o = l, n = a)
                }
                return n
            }
            ...
            key: "sort", value: function (e) {
                ...
                return new t(fn({}, gh, (function () {
                    ...
                    return Rh(iu(t = Bn(i._pairs)).call(t, (function (t, i) {
                        var n = jn(t, 2), o = n[0], r = n[1], s = jn(i, 2), a = s[0], l = s[1];
                        return e(r, l, o, a)
                    })))
                })))
            }
    ...
    var Yu = function (t) {
        ...
        return pn(i, [{
            key: "idProp", get: function () {
                return this._idProp
            }
        }, {
            key: "setOptions", value: function (t) {
                t && void 0 !== t.queue && (!1 === t.queue ? this._queue && (this._queue.destroy(), this._queue = null) : (this._queue || (this._queue = Nu.extend(this, {replace: ["add", "update", "remove"]})), t.queue && "object" === Gn(t.queue) && this._queue.setOptions(t.queue)))
            }
        }, {
            ...
            key: "update", value: function (t, e) {
                var i = this, n = [], o = [], r = [], s = [], a = this._idProp, l = function (t) {
                    var e = t[a];
                    if (null != e && i._data.has(e)) {
                        var l = t, h = Fo({}, i._data.get(e)), u = i._updateItem(l);
                ...
                if ($n(t)) for (var h = 0, u = t.length; h < u; h++) t[h] && "object" === Gn(t[h]) ? l(t[h]) : console.warn("Ignoring input item, which is not an object at index " + h); else {
                    if (!t || "object" !== Gn(t)) throw new Error("Unknown dataType");
                    l(t)
                }
            ...
            key: "updateOnly", value: function (t, e) {
                ...
                var o = eo(i = eo(t).call(t, (function (t) {
                    ...
                    var e = t.oldData, i = t.update, o = e[n._idProp], r = Ya(e, i);
            ...
            key: "get", value: function (t, e) {
                ...
                var r, s = o && "Object" === o.returnType ? "Object" : "Array", a = o && Qo(o), l = [], h = void 0,
                    u = void 0, d = void 0;
                if (null != i) (h = this._data.get(i)) && a && !a(h) && (h = void 0); else if (null != n) for (var c = 0, p = n.length; c < p; c++) null == (h = this._data.get(n[c])) || a && !a(h) || l.push(h); else for (var f, m = 0, v = (u = Bn(du(f = this._data).call(f))).length; m < v; m++) d = u[m], null == (h = this._data.get(d)) || a && !a(h) || l.push(h);
                if (o && o.order && null == i && this._sort(l, o.order), o && o.fields) {
                    var g = o.fields;
                    if (null != i && null != h) h = this._filterFields(h, g); else for (var y = 0, b = l.length; y < b; y++) l[y] = this._filterFields(l[y], g)
                }
                if ("Object" == s) {
            ...
            key: "getIds", value: function (t) {
                var e = this._data, i = t && Qo(t), n = t && t.order, o = Bn(du(e).call(e)), r = [];
                if (i) if (n) {
                    for (var s = [], a = 0, l = o.length; a < l; a++) {
                        var h = o[a], u = this._data.get(h);
                        null != u && i(u) && s.push(u)
                    }
                    this._sort(s, n);
                    for (var d = 0, c = s.length; d < c; d++) r.push(s[d][this._idProp])
                } else for (var p = 0, f = o.length; p < f; p++) {
                    var m = o[p], v = this._data.get(m);
                ...
                } else for (var x = 0, D = o.length; x < D; x++) {
                    var S = o[x], C = e.get(S);
            ...
            key: "forEach", value: function (t, e) {
                var i = e && Qo(e), n = this._data, o = Bn(du(n).call(n));
                if (e && e.order) for (var r = this.get(e), s = 0, a = r.length; s < a; s++) {
                    var l = r[s];
                    t(l, l[this._idProp])
                } else for (var h = 0, u = o.length; h < u; h++) {
                    var d = o[h], c = this._data.get(d);
                    null == c || i && !i(c) || t(c, d)
                }
            }
        }, {
            ...
            key: "max", value: function (t) {
                var e, i, n = null, o = null, r = Ou(mu(e = this._data).call(e));
                try {
                    for (r.s(); !(i = r.n()).done;) {
                        var s = i.value, a = s[t];
            ...
            key: "distinct", value: function (t) {
                for (var e = this._data, i = Bn(du(e).call(e)), n = [], o = 0, r = 0, s = i.length; r < s; r++) {
                    for (var a = i[r], l = e.get(a)[t], h = !1, u = 0; u < o; u++) if (n[u] == l) {
                        h = !0;
                        break
                    }
                    h || void 0 === l || (n[o] = l, o++)
            ...
            key: "_addItem", value: function (t) {
                ...
                }(t, this._idProp), i = e[this._idProp];
        ...
        return pn(i, [{
            ...
            key: "setData", value: function (t) {
                if (this._data) {
                    ...
                    var e = this._data.getIds({filter: Qo(this._options)}), i = this._data.get(e);
                    this._ids.clear(), this.length = 0, this._trigger("remove", {items: e, oldData: i})
                }
                if (null != t) {
                    this._data = t;
                    for (var n = this._data.getIds({filter: Qo(this._options)}), o = 0, r = n.length; o < r; o++) {
                        var s = n[o];
                        this._ids.add(s)
                    }
            ...
            key: "refresh", value: function () {
                for (var t = this._data.getIds({filter: Qo(this._options)}), e = Bn(this._ids), i = {}, n = [], o = [], r = [], s = 0, a = t.length; s < a; s++) {
                    var l = t[s];
                    i[l] = !0, this._ids.has(l) || (n.push(l), this._ids.add(l))
                }
                for (var h = 0, u = e.length; h < u; h++) {
                    var d = e[h], c = this._data.get(d);
                    null == c ? console.error("If you see this, report it please.") : i[d] || (o.push(d), r.push(c), this._ids.delete(d))
                }
                this.length += n.length - o.length, n.length && this._trigger("add", {items: n}), o.length && this._trigger("remove", {
                    items: o,
                    oldData: r
                })
            }
            ...
            key: "get", value: function (t, e) {
                ...
                var o = Fo({}, this._options, i), r = Qo(this._options), s = i && Qo(i);
            ...
            key: "getIds", value: function (t) {
                if (this._data.length) {
                    var e, i = Qo(this._options), n = null != t ? Qo(t) : null;
            ...
            key: "forEach", value: function (t, e) {
                if (this._data) {
                    var i, n, o = Qo(this._options), r = e && Qo(e);
                    n = r ? o ? function (t) {
                        return o(t) && r(t)
                    } : r : o, bo(i = this._data).call(i, t, {filter: n, order: e && e.order})
                }
            }
        }, {
            key: "map", value: function (t, e) {
                if (this._data) {
                    ...
                    return n = r ? o ? function (t) {
                        return o(t) && r(t)
                    } : r : o, eo(i = this._data).call(i, t, {filter: n, order: e && e.order})
                }
                return []
            }
        }, {
            ...
            key: "_onEvent", value: function (t, e, i) {
                if (e && e.items && this._data) {
                    ...
                    this.length += o.length - s.length, o.length && this._trigger("add", {items: o}, i), r.length && this._trigger("update", {
                        items: r,
                        oldData: a,
                        data: l
                    }, i), s.length && this._trigger("remove", {items: s, oldData: h}, i)
                }
            }
        }]), i
    }(Fu);
    ...
    var Wu = {
        whiteList: Gu(), getDefaultWhiteList: Gu, onAttr: function (t, e, i) {
    ...
    var Xu = function (t, e) {
        ";" !== (t = Uu(t))[t.length - 1] && (t += ";");
        var i = t.length, n = !1, o = 0, r = 0, s = "";

        function a() {
            if (!n) {
                var i = Vu(t.slice(o, r)), a = i.indexOf(":");
                if (-1 !== a) {
                    var l = Vu(i.slice(0, a)), h = Vu(i.slice(a + 1));
                    if (l) {
    ...
    var $u = Zu, Ku = i((function (t, e) {
        ...
        var e = /\s|\n|\t/.exec(t);
        return e ? e.index : -1
    }, id = Ku.FilterCSS, nd = Ku.getDefaultWhiteList;
    ...
    var ad = /</g, ld = />/g, hd = /"/g, ud = /&quot;/g, dd = /&#([a-zA-Z0-9]*);?/gim, cd = /&colon;?/gim,
        pd = /&newline;?/gim,
        fd = /((j\s*a\s*v\s*a|v\s*b|l\s*i\s*v\s*e)\s*s\s*c\s*r\s*i\s*p\s*t\s*|m\s*o\s*c\s*h\s*a)\:/gi,
        md = /e\s*x\s*p\s*r\s*e\s*s\s*s\s*i\s*o\s*n\s*\(.*/gi, vd = /u\s*r\s*l\s*\(.*/gi;
            ...
            return {
                onIgnoreTag: function (r, s, a) {
                    if (function (e) {
                        ...
                        if (a.isClosing) {
                            var l = "[/removed]", h = a.position + l.length;
    ...
    function Cd(t) {
        var e = ed(t);
        if (-1 === e) var i = t.slice(1, -1); else i = t.slice(1, e + 1);
    ...
    var Ad = {
        parseTag: function (t, e, i) {
            var n = "", o = 0, r = !1, s = !1, a = 0, l = t.length, h = "", u = "";
            t:for (a = 0; a < l; a++) {
                var d = t.charAt(a);
                if (!1 === r) {
                    if ("<" === d) {
                    ...
                    if ('"' === d || "'" === d) for (var c = 1, p = t.charAt(a - c); "" === p.trim() || "=" === p;) {
                        if ("=" === p) {
                            s = d;
                            continue t
                        }
            ...
            for (var a = 0; a < r; a++) {
                var l, h = t.charAt(a);
                if (!1 !== o || "=" !== h) if (!1 === o || a !== i || '"' !== h && "'" !== h || "=" !== t.charAt(a - 1)) if (/\s|\n|\t/.test(h)) {
                    if (t = t.replace(/\s|\n|\t/g, " "), !1 === o) {
                        if (-1 === (l = Od(t, a))) {
    ...
    }, Ld = Ku.FilterCSS, Id = Ad.parseTag, Nd = Ad.parseAttr;
    ...
    Rd.prototype.process = function (t) {
        if (!(t = (t = t || "").toString())) return "";
        var e = this.options, i = e.whiteList, n = e.onTag, o = e.onIgnoreTag, r = e.onTagAttr, s = e.onIgnoreTagAttr,
            a = e.safeAttrValue, l = e.escapeHtml, h = this.cssFilter;
        ...
        var d = Id(t, (function (t, e, u, d, c) {
            var p, f = {sourcePosition: t, position: e, isClosing: c, isWhite: i.hasOwnProperty(u)};
            ...
            if (f.isWhite) {
                ...
                var m = function (t) {
                    ...
                    return i && (t = td(t.slice(0, -1))), {html: t, closing: i}
                }(d), v = i[u], g = Nd(m.html, (function (t, e) {
                    var i, n = -1 !== Ju(v, t);
    ...
    function Vd(t) {
        var e, i, n, o, r, s,
            ...
            l = t._idProp, h = new Yu({fieldId: l}), u = eo(e = Pu(t)).call(e, (function (t) {
                var e;
    ...
    var Ud = function (t) {
        ...
        convert: Wd, setupXSSProtection: function (t) {
    ...
    var $d = hr.trim, Kd = c.parseFloat, Jd = 1 / Kd(or + "-0") != -1 / 0 ? function (t) {
        var e = $d(String(t)), i = Kd(e);
        return 0 === i && "-" == e.charAt(0) ? -0 : i
    } : Kd;
    xt({global: !0, forced: parseFloat != Jd}, {parseFloat: Jd});
    var Qd = yt.parseFloat, tc = function () {
        function t(e, i) {
    ...
    xt({target: "String", proto: !0}, {
        repeat: function (t) {
            var e = String(l(this)), i = "", n = a(t);
            if (n < 0 || n == 1 / 0) throw RangeError("Wrong number of repetitions");
            for (; n > 0; (n >>>= 1) && (e += e)) 1 & n && (i += e);
            return i
        }
    });
    var ec = Pn("String").repeat, ic = String.prototype, nc = function (t) {
        var e = t.repeat;
    ...
    function oc(t, e, i) {
        ...
        if (e.hiddenDates = [], i && 1 == $n(i)) {
            for (var n, o = 0; o < i.length; o++) if (void 0 === nc(i[o])) {
                var r = {};
    ...
    function rc(t, e, i) {
        ...
        if (i && void 0 !== e.domProps.centerContainer.width) {
            oc(t, e, i);
            for (var n = t(e.range.start), o = t(e.range.end), r = (e.range.end - e.range.start) / e.domProps.centerContainer.width, s = 0; s < i.length; s++) if (void 0 !== nc(i[s])) {
                var a = t(i[s].start), l = t(i[s].end);
                ...
                if (l - a >= 4 * r) {
                    ...
                    for (; a < u;) switch (e.hiddenDates.push({start: a.valueOf(), end: l.valueOf()}), nc(i[s])) {
                        case"daily":
            ...
            sc(e);
            var p = vc(e.range.start, e.hiddenDates), f = vc(e.range.end, e.hiddenDates), m = e.range.start,
                v = e.range.end;
    ...
    function ac(t, e, i) {
        for (var n = !1, o = e.current.valueOf(), r = 0; r < e.hiddenDates.length; r++) {
            var s = e.hiddenDates[r].start, a = e.hiddenDates[r].end;
            if (o >= s && o < a) {
                n = !0;
                break
            }
    ...
    function hc(t, e, i) {
        ...
        var o = uc(t.body.hiddenDates, t.range.start, t.range.end), r = (t.range.end - t.range.start - o) * e / i,
    ...
    var bc = function (t) {
        ...
        function i(t, n) {
            ...
            var c = zu().hours(0).minutes(0).seconds(0).milliseconds(0), p = c.clone().add(-3, "days").valueOf(),
        ...
        return pn(i, [{
            ...
            key: "startRolling", value: function () {
                var t = this;
                !function e() {
                    t.stopRolling(), t.rolling = !0;
                    var i = t.end - t.start, n = Zd.convert(new Date, "Date").valueOf(),
                        o = t.options.rollingMode && t.options.rollingMode.offset || .5, r = n - i * o,
                        s = n + i * (1 - o);
                    t.setRange(r, s, {animation: !1}), (i = 1 / t.conversion(t.body.domProps.center.width).scale / 10) < 30 && (i = 30), i > 1e3 && (i = 1e3), t.body.dom.rollingModeBtn.style.visibility = "hidden", t.currentTimeTimer = Hr(e, i)
                }()
            }
        }, {
            key: "stopRolling", value: function () {
                ...
                if (this._cancelAnimation(), this.millisecondsPerPixelCache = void 0, i.animation) {
                    ...
                    return function t() {
                        if (!r.props.touch.dragging) {
                            var e = oo() - f, l = p(e / d), c = e > d, g = c || null === s ? s : h + (s - h) * l,
            ...
            key: "getMillisecondsPerPixel", value: function () {
            ...
            key: "conversion", value: function (t, e) {
            ...
            key: "_onDrag", value: function (t) {
                if (t && this.props.touch.dragging && this.options.moveable && this.props.touch.allowDragging) {
                    ...
                    var s = this.props.touch.start + o, a = this.props.touch.end + o,
                    ...
                    var u = new Date(this.start), d = new Date(this.end);
            ...
            key: "_onMouseWheel", value: function (t) {
                var e = 0;
            ...
            key: "_onPinch", value: function (t) {
                if (this.options.zoomable && this.options.moveable) {
                    ...
                    var e = 1 / (t.scale + this.scaleOffset), i = this.props.touch.centerDate,
                        n = uc(this.body.hiddenDates, this.start, this.end),
                        o = pc(this.options.moment, this.body.hiddenDates, this, i), r = n - o,
                        s = i - o + (this.props.touch.start - (i - o)) * e,
                        a = i + r + (this.props.touch.end - (i + r)) * e;
                    this.startToFront = 1 - e <= 0, this.endToFront = e - 1 <= 0;
                    var l = mc(this.body.hiddenDates, s, 1 - e, !0), h = mc(this.body.hiddenDates, a, e - 1, !0);
            ...
            key: "_isInsideRange", value: function (t) {
                var e = t.center ? t.center.x : t.clientX, i = this.body.dom.centerContainer.getBoundingClientRect(),
                    n = this.options.rtl ? e - i.left : i.right - e, o = this.body.util.toTime(n);
                return o >= this.start && o <= this.end
            }
        }, {
            key: "_pointerToDate", value: function (t) {
            ...
            key: "getPointer", value: function (t, e) {
                var i = e.getBoundingClientRect();
                return this.options.rtl ? {x: i.right - t.x, y: t.y - i.top} : {x: t.x - i.left, y: t.y - i.top}
            }
        }, {
            key: "zoom", value: function (t, e, i, n) {
                null == e && (e = (this.start + this.end) / 2);
                var o = uc(this.body.hiddenDates, this.start, this.end),
                    r = pc(this.options.moment, this.body.hiddenDates, this, e), s = o - r,
                    a = e - r + (this.start - (e - r)) * t, l = e + s + (this.end - (e + s)) * t;
                this.startToFront = !(i > 0), this.endToFront = !(-i > 0);
                var h = mc(this.body.hiddenDates, a, i, !0), u = mc(this.body.hiddenDates, l, -i, !0);
                h == a && u == l || (a = h, l = u);
            ...
            key: "move", value: function (t) {
                var e = this.end - this.start, i = this.start + e * t, n = this.end + e * t;
                this.start = i, this.end = n
            }
        }, {
            key: "moveTo", value: function (t) {
                var e = (this.start + this.end) / 2 - t, i = this.start - e, n = this.end - e;
                this.setRange(i, n, {animation: !1, byUser: !0, event: null})
            }
        }], [{
            key: "conversion", value: function (t, e, i, n) {
                return void 0 === n && (n = 0), 0 != i && e - t != 0 ? {offset: t, scale: i / (e - t - n)} : {
                    offset: 0,
                    scale: 1
                }
            }
    ...
    "undefined" != typeof window ? wc = function t(e, i) {
        ...
        var s = Object.create(e), a = e.element;
        ...
        return a.hammer || (a.hammer = []), a.hammer.push(s), e.on("hammer.input", (function (t) {
            ...
            var t = e.element.hammer, i = t.indexOf(s);
            -1 !== i && t.splice(i, 1), t.length || delete e.element.hammer, s._handlers = {}, e.destroy()
        }, s
    }(window.Hammer || Aa, {preventDefault: "mouse"}) : wc = function () {
        return {
            on: t = function () {
            }, off: t, destroy: t, emit: t, get: function (e) {
                return {set: t}
            }
        };
        var t
    ...
    var Cc = function () {
        ...
        return pn(t, [{
            key: "setMoment", value: function (t) {
            ...
            key: "setFormat", value: function (e) {
                var i = Zd.deepExtend({}, t.FORMAT);
                this.format = Zd.deepExtend(i, e)
            }
        }, {
            key: "setRange", value: function (t, e, i) {
            ...
            key: "roundToMinor", value: function () {
            ...
            key: "setAutoScale", value: function (t) {
                this.autoScale = t
            }
        }, {
            key: "setMinimumStep", value: function (t) {
                if (null != t) {
                    var e = 31104e6, i = 2592e6, n = 864e5, o = 36e5, r = 6e4, s = 1e3;
            ...
            key: "getLabelMinor", value: function (t) {
            ...
            key: "getLabelMajor", value: function (t) {
            ...
            key: "getClassName", value: function () {
                var t, e = this.moment, i = this.moment(this.current), n = i.locale ? i.locale("en") : i.lang("en"),
                    o = this.step, r = [];
    ...
    var Oc = function (t) {
        ...
        return pn(i, [{
            ...
            key: "redraw", value: function () {
                ...
                var a = e.nextSibling, l = i.nextSibling;
            ...
            key: "_repaintLabels", value: function () {
                var t = this.options.orientation.axis, e = Zd.convert(this.body.range.start, "Number"),
                ...
                var p, f, m, v = 0, g = void 0, y = 0, b = 1e3;
                ...
                if (y !== b || Ec || (console.warn("Something is wrong with the Timeline scale. Limited drawing of grid lines to ".concat(b, " lines.")), Ec = !0), this.options.showMajorLabels) {
                    var w = this.body.util.toTime(0), k = r.getLabelMajor(w),
            ...
            key: "_repaintMinorText", value: function (t, e, i, n) {
            ...
            key: "_repaintMajorText", value: function (t, e, i, n) {
            ...
            key: "_repaintMinorLine", value: function (t, e, i, n) {
                ...
                var a = "top" == i ? s.majorLabelHeight : this.body.domProps.top.height, l = t - s.minorLineWidth / 2;
            ...
            key: "_repaintMajorLine", value: function (t, e, i, n) {
                var o, r = this.dom.redundant.lines.shift();
                r || (r = document.createElement("div"), this.dom.background.appendChild(r)), this.dom.lines.push(r);
                var s = this.props;
                r.style.width = "".concat(e, "px"), r.style.height = "".concat(s.majorLineHeight, "px");
                var a = "top" == i ? 0 : this.body.domProps.top.height, l = t - s.majorLineWidth / 2;
            ...
            key: "_calculateCharSize", value: function () {
    ...
    function Pc(t) {
        var e, i = t && t.preventDefault || !1, n = t && t.container || window, o = {}, r = {keydown: {}, keyup: {}},
            s = {};
        ...
        s["num*"] = {code: 106, shift: !1}, s["num+"] = {code: 107, shift: !1}, s["num-"] = {
            code: 109,
            shift: !1
        }, s["num/"] = {code: 111, shift: !1}, s["num."] = {code: 110, shift: !1}, s.left = {
            code: 37,
            shift: !1
        }, s.up = {code: 38, shift: !1}, s.right = {code: 39, shift: !1}, s.down = {
            code: 40,
            shift: !1
        }, s.space = {code: 32, shift: !1}, s.enter = {code: 13, shift: !1}, s.shift = {
            code: 16,
            shift: void 0
        }, s.esc = {code: 27, shift: !1}, s.backspace = {code: 8, shift: !1}, s.tab = {
            code: 9,
            shift: !1
        }, s.ctrl = {code: 17, shift: !1}, s.alt = {code: 18, shift: !1}, s.delete = {
            code: 46,
            shift: !1
        }, s.pageup = {code: 33, shift: !1}, s.pagedown = {code: 34, shift: !1}, s["="] = {
            code: 187,
            shift: !1
        }, s["-"] = {code: 189, shift: !1}, s["]"] = {code: 221, shift: !1}, s["["] = {code: 219, shift: !1};
        var a = function (t) {
            h(t, "keydown")
        }, l = function (t) {
            h(t, "keyup")
    ...
    function Ac(t) {
        var e, i;
        this.active = !1, this.dom = {container: t}, this.dom.overlay = document.createElement("div"), this.dom.overlay.className = "vis-overlay", this.dom.container.appendChild(this.dom.overlay), this.hammer = Dc(this.dom.overlay), this.hammer.on("tap", co(e = this._onTapOverlay).call(e, this));
        var n = this, o = ["tap", "doubletap", "press", "pinch", "pan", "panstart", "panmove", "panend"];
        bo(o).call(o, (function (t) {
    ...
    var Lc = {current: "current", time: "time", deleteSelected: "Delete selected"},
        Ic = {current: "attuale", time: "tempo", deleteSelected: "Cancella la selezione"},
        Nc = {current: "huidige", time: "tijd", deleteSelected: "Selectie verwijderen"},
        Fc = {current: "Aktuelle", time: "Zeit", deleteSelected: "Lösche Auswahl"},
        Rc = {current: "actuel", time: "heure", deleteSelected: "Effacer la selection"},
        Yc = {current: "corriente", time: "hora", deleteSelected: "Eliminar selección"},
        jc = {current: "поточний", time: "час", deleteSelected: "Видалити обране"},
        Hc = {current: "текущее", time: "время", deleteSelected: "Удалить выбранное"},
        zc = {current: "aktualny", time: "czas", deleteSelected: "Usuń wybrane"},
        Gc = {current: "atual", time: "data", deleteSelected: "Apagar selecionado"},
        Bc = {current: "現在", time: "時刻", deleteSelected: "選択されたものを削除"},
        Wc = {current: "nuvarande", time: "tid", deleteSelected: "Radera valda"},
        Vc = {current: "nåværende", time: "tid", deleteSelected: "Slett valgte"}, Uc = {
            en: Lc,
            en_EN: Lc,
            en_US: Lc,
            it: Ic,
    ...
    var qc = function (t) {
        ...
        return pn(i, [{
            ...
            key: "setCustomTime", value: function (t) {
                this.customTime = Zd.convert(t, "Date"), this.redraw()
            }
        }, {
            key: "getCustomTime", value: function () {
                return new Date(this.customTime.valueOf())
            }
        }, {
            key: "setCustomMarker", value: function (t, e) {
            ...
            key: "setCustomTitle", value: function (t) {
            ...
            key: "_onDrag", value: function (t) {
                if (this.eventParams.dragging) {
                    var e = this.options.rtl ? -1 * t.deltaX : t.deltaX,
                        i = this.body.util.toScreen(this.eventParams.customTime) + e, n = this.body.util.toTime(i),
                        o = this.body.util.getScale(), r = this.body.util.getStep(), s = this.options.snap,
                        a = s ? s(n, o, r) : n;
            ...
            key: "_onMarkerChange", value: function (t) {
            ...
            key: "_onMarkerChanged", value: function (t) {
            ...
            key: "customTimeFromTarget", value: function (t) {
        ...
        return pn(t, [{
            key: "_create", value: function (t) {
                ...
                function u(t) {
                    ...
                    if (this.options.verticalScroll || this.options.horizontalScroll) if (this.options.verticalScroll && Math.abs(i) >= Math.abs(e)) {
                        var n = this.props.scrollTop, o = n + i;
                        ...
                        var r = (Math.abs(e) >= Math.abs(i) ? e : i) / 120 * (this.range.end - this.range.start) / 20,
                            s = this.range.start + r, a = this.range.end + r, l = {animation: !1, byUser: !0, event: t};
            ...
            key: "setOptions", value: function (t) {
                ...
                if (t) {
                    ...
                    "function" == typeof t.drawPoints && (t.drawPoints = {onRender: t.drawPoints}), "hiddenDates" in this.options && oc(this.options.moment, this.body, this.options.hiddenDates), "clickToUse" in t && (t.clickToUse ? this.activator || (this.activator = new Ac(this.dom.root)) : this.activator && (this.activator.destroy(), delete this.activator)), this._initAutoResize()
                }
            ...
            key: "setCustomTime", value: function (t, e) {
            ...
            key: "getCustomTime", value: function (t) {
            ...
            key: "setCustomTimeMarker", value: function (t, e, i) {
            ...
            key: "setCustomTimeTitle", value: function (t, e) {
                var i, n = Qo(i = this.customTimes).call(i, (function (t) {
                    return t.options.id === e
                }));
                if (0 === n.length) throw new Error("No custom time bar found with id ".concat(Fr(e)));
            ...
            key: "getEventProperties", value: function (t) {
                return {event: t}
            }
        }, {
            key: "addCustomTime", value: function (t, e) {
            ...
            key: "removeCustomTime", value: function (t) {
                var e, i = this, n = Qo(e = this.customTimes).call(e, (function (e) {
                    return e.options.id === t
                }));
            ...
            key: "getVisibleItems", value: function () {
                return this.itemSet && this.itemSet.getVisibleItems() || []
            }
        }, {
            key: "getItemsAtCurrentTime", value: function (t) {
                return this.time = t, this.itemSet && this.itemSet.getItemsAtCurrentTime(this.time) || []
            }
        }, {
            key: "getVisibleGroups", value: function () {
                return this.itemSet && this.itemSet.getVisibleGroups() || []
            }
        }, {
            key: "fit", value: function (t, e) {
                var i = this.getDataRange();
                if (null !== i.min || null !== i.max) {
                    var n = i.max - i.min, o = new Date(i.min.valueOf() - .01 * n),
                        r = new Date(i.max.valueOf() + .01 * n), s = !t || void 0 === t.animation || t.animation;
            ...
            key: "setWindow", value: function (t, e, i, n) {
                var o, r;
                "function" == typeof arguments[2] && (n = arguments[2], i = {}), 1 == arguments.length ? (o = void 0 === (r = arguments[0]).animation || r.animation, this.range.setRange(r.start, r.end, {animation: o})) : 2 == arguments.length && "function" == typeof arguments[1] ? (n = arguments[1], o = void 0 === (r = arguments[0]).animation || r.animation, this.range.setRange(r.start, r.end, {animation: o}, n)) : (o = !i || void 0 === i.animation || i.animation, this.range.setRange(t, e, {animation: o}, n))
            }
        }, {
            key: "moveTo", value: function (t, e, i) {
                "function" == typeof arguments[1] && (i = arguments[1], e = {});
                var n = this.range.end - this.range.start, o = Zd.convert(t, "Date").valueOf(), r = o - n / 2,
                    s = o + n / 2, a = !e || void 0 === e.animation || e.animation;
            ...
            key: "zoomIn", value: function (t, e, i) {
                if (!(!t || t < 0 || t > 1)) {
                    "function" == typeof arguments[1] && (i = arguments[1], e = {});
                    var n = this.getWindow(), o = n.start.valueOf(), r = n.end.valueOf(), s = r - o, a = s / (1 + t),
                        l = (s - a) / 2, h = o + l, u = r - l;
                    this.setWindow(h, u, e, i)
                }
            }
        }, {
            key: "zoomOut", value: function (t, e, i) {
                if (!(!t || t < 0 || t > 1)) {
                    "function" == typeof arguments[1] && (i = arguments[1], e = {});
                    var n = this.getWindow(), o = n.start.valueOf(), r = n.end.valueOf(), s = r - o, a = o - s * t / 2,
                        l = r + s * t / 2;
            ...
            key: "_redraw", value: function () {
                ...
                if (e && e.container && 0 != e.root.offsetWidth) {
                    var i = !1, n = this.options, o = this.props;
                    ...
                    var c = 0 == o.scrollTop ? "hidden" : "", p = o.scrollTop == o.scrollTopMin ? "hidden" : "";
                    ...
                    this.hammer.get("pan").set({direction: f ? Dc.DIRECTION_ALL : Dc.DIRECTION_HORIZONTAL}), this.hammer.get("press").set({time: this.options.longSelectPressTime}), bo(t = this.components).call(t, (function (t) {
                        i = t.redraw() || i
                    }));
                    if (i) {
            ...
            key: "_stopAutoResize", value: function () {
            ...
            key: "_onDrag", value: function (t) {
                if (t && this.touch.allowDragging) {
                    var e = t.deltaY, i = this._getScrollTop(), n = this._setScrollTop(this.touch.initialScrollTop + e);
            ...
            key: "_createConfigurator", value: function () {
        ...
        return pn(i, [{
            ...
            key: "redraw", value: function () {
                if (this.options.showCurrentTime) {
                    ...
                    var o = this.body.util.toScreen(n), r = this.options.locales[this.options.locale];
            ...
            key: "setCurrentTime", value: function (t) {
                var e = Zd.convert(t, "Date").valueOf(), i = oo();
    ...
    }(tc), Jc = xi.find, Qc = "find", tp = !0;
    Qc in [] && Array(1).find((function () {
        tp = !1
    })), xt({target: "Array", proto: !0, forced: tp}, {
        find: function (t) {
            return Jc(this, t, arguments.length > 1 ? arguments[1] : void 0)
        }
    });
    var ep = Pn("Array").find, ip = Array.prototype, np = function (t) {
        var e = t.find;
    ...
    function ap(t, e, i, n) {
        if (i) for (var o = 0; o < t.length; o++) t[o].top = null;
    ...
    function up(t, e, i) {
        for (var n in i) if (i.hasOwnProperty(n)) {
            ...
            do {
                var o = null;
                for (var r in i) if (null !== i[r].top && r !== n && i[n].index > i[r].index && pp(i[n], i[r])) {
                    o = i[r];
                    break
                }
    ...
    function pp(t, e) {
        var i = t.start < e.end && t.end > e.start, n = t.top < e.top + e.height && t.top + t.height > e.top;
        return i && n
    }
        ...
        return pn(t, [{
            ...
            key: "setData", value: function (t) {
                if (!this.itemSet.groupTouchParams.isDragging) {
                    ...
                    if (this.itemSet.options && this.itemSet.options.groupTemplate) e = (i = co(n = this.itemSet.options.groupTemplate).call(n, this))(t, this.dom.inner); else e = t && t.content;
            ...
            key: "_didMarkerHeightChange", value: function () {
            ...
            key: "_calculateGroupSizeAndPosition", value: function () {
                var t = this.dom.foreground, e = t.offsetTop, i = t.offsetLeft, n = t.offsetWidth;
                this.top = e, this.right = i, this.width = n
            }
        }, {
            key: "_shouldBailItemsRedraw", value: function () {
                var t = this, e = this.itemSet.options.onTimeout, i = {
            ...
            key: "_redrawItems", value: function (t, e, i, n) {
                var o = this;
                if (t || this.stackDirty || this.isVisible && !e) {
                    var r, s, a, l, h, u, d = {
                        ...
                        var t, e, i, r = o._updateItemsInRange(d, Qo(t = o.visibleItems).call(t, (function (t) {
                            return !t.isCluster
                        })), n), s = o._updateClustersInRange(c, Qo(e = o.visibleItems).call(e, (function (t) {
                            return t.isCluster
                        })), n);
            ...
            key: "_updateItemsVerticalPosition", value: function (t) {
            ...
            key: "redraw", value: function (t, e, i, n) {
                var o, r, s, a, l, h, u, d = this, c = !1, p = this.isVisible, f = [function () {
            ...
            key: "_updateSubGroupHeights", value: function (t) {
                var e = this;
            ...
            key: "_isGroupVisible", value: function (t, e) {
            ...
            key: "_addToSubgroup", value: function (t) {
            ...
            key: "_updateSubgroupsSizes", value: function () {
                var t = this;
                if (t.subgroups) {
                    var e = function (e) {
                        var i, n = t.subgroups[e].items[0].data.end || t.subgroups[e].items[0].data.start,
                            o = t.subgroups[e].items[0].data.start, r = n - 1;
            ...
            key: "orderSubgroups", value: function () {
            ...
            key: "_resetSubgroups", value: function () {
            ...
            key: "remove", value: function (t) {
                ...
                var n = kr(e = this.visibleItems).call(e, t);
                -1 != n && Ao(i = this.visibleItems).call(i, n, 1), void 0 !== t.data.subgroup && (this._removeFromSubgroup(t), this.orderSubgroups())
            }
        }, {
            key: "_removeFromSubgroup", value: function (t) {
                var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : t.data.subgroup;
                if (null != e) {
            ...
            key: "removeFromDataSet", value: function (t) {
            ...
            key: "order", value: function () {
                ...
                this.orderedItems = {byStart: e, byEnd: i}, rp(this.orderedItems.byStart), sp(this.orderedItems.byEnd)
            }
        }, {
            key: "_updateItemsInRange", value: function (t, e, i) {
                var n = [], o = {};
                ...
                var a = (i.end - i.start) / 4, l = i.start - a, h = i.end + a;
            ...
            key: "_traceVisible", value: function (t, e, i, n, o) {
                if (-1 != t) {
                    for (var r = t; r >= 0; r--) {
                        var s = e[r];
                        if (o(s)) break;
            ...
            key: "_checkIfVisible", value: function (t, e, i) {
                t.isVisible(i) ? (t.displayed || t.show(), t.repositionX(), e.push(t)) : t.displayed && t.hide()
            }
        }, {
            key: "_checkIfVisibleWithReference", value: function (t, e, i, n) {
                t.isVisible(n) ? void 0 === i[t.id] && (i[t.id] = !0, e.push(t)) : t.displayed && t.hide()
            }
        }, {
            key: "_updateClustersInRange", value: function (t, e, i) {
                var n = [], o = {};
                ...
                if (h > 0) for (var c = 0; c < h; c++) bo(Zd).call(Zd, l, (function (t) {
                    t[c]()
                }));
            ...
            key: "changeSubgroup", value: function (t, e, i) {
    ...
    var yp = function (t) {
        ...
        return pn(i, [{
            key: "redraw", value: function (t, e, i) {
    ...
    var wp = function () {
        ...
        return pn(t, [{
            ...
            key: "setSelectability", value: function (t) {
            ...
            key: "_repaintDragCenter", value: function () {
                if (this.selected && this.editable.updateTime && !this.dom.dragCenter) {
                    var t, e, i = this, n = document.createElement("div");
            ...
            key: "_repaintDeleteButton", value: function (t) {
            ...
            key: "_repaintOnItemUpdateTimeTooltip", value: function (t) {
            ...
            key: "_getItemData", value: function () {
            ...
            key: "_updateContents", value: function (t) {
                ...
                if (l) if (n instanceof Object && !(n instanceof Element)) o(a, l); else if (this._contentToString(this.itemVisibleFrameContent) !== this._contentToString(n)) {
                    if (n instanceof Element) l.innerHTML = "", l.appendChild(n); else if (null != n) l.innerHTML = Zd.xss(n); else if ("background" != this.data.type || void 0 !== this.data.content) throw new Error('Property "content" missing in item '.concat(this.id));
                ...
                if (e instanceof Object && !(e instanceof Element)) i(a, t); else if (this._contentToString(this.content) !== this._contentToString(e)) {
                    if (e instanceof Element) t.innerHTML = "", t.appendChild(e); else if (null != e) t.innerHTML = Zd.xss(e); else if ("background" != this.data.type || void 0 !== this.data.content) throw new Error('Property "content" missing in item '.concat(this.id));
                    this.content = e
                }
            }
        }, {
            key: "_updateDataAttributes", value: function (t) {
                if (this.options.dataAttributes && this.options.dataAttributes.length > 0) {
                    var e = [];
                    if ($n(this.options.dataAttributes)) e = this.options.dataAttributes; else {
            ...
            key: "_updateStyle", value: function (t) {
            ...
            key: "_contentToString", value: function (t) {
                return "string" == typeof t ? t : t && "outerHTML" in t ? t.outerHTML : t
            }
        }, {
            key: "_updateEditStatus", value: function () {
            ...
            key: "getWidthLeft", value: function () {
                return 0
            }
        }, {
            key: "getWidthRight", value: function () {
                return 0
            }
        }, {
    ...
    var xp = function (t) {
        ...
        return pn(i, [{
            key: "isVisible", value: function (t) {
                ...
                var e, i = this.data.align || this.options.align, n = this.width * t.getMillisecondsPerPixel();
            ...
            key: "_createDomElement", value: function () {
            ...
            key: "_appendDomElement", value: function () {
            ...
            key: "_updateDirtyDomComponents", value: function () {
                if (this.dirty) {
            ...
            key: "_getDomComponentsSizes", value: function () {
                return {
            ...
            key: "_updateDomComponentsSizes", value: function (t) {
            ...
            key: "repositionXY", value: function () {
                var t = this.options.rtl, e = function (t, e, i) {
            ...
            key: "repositionX", value: function () {
                var t = this.conversion.toScreen(this.data.start),
                    e = void 0 === this.data.align ? this.options.align : this.data.align, i = this.props.line.width,
            ...
            key: "repositionY", value: function () {
                var t = this.options.orientation.item, e = this.dom.line.style;
                if ("top" == t) {
    ...
    var Sp = function (t) {
        ...
        return pn(i, [{
            ...
            key: "_updateDomComponentsSizes", value: function (t) {
                ...
                var e = this.props.dot.width, i = this.options.rtl ? e / 2 : e / 2 * -1;
    ...
    var Tp = function (t) {
        ...
        function i(t, n, o) {
            var r;
            if (un(this, i), (r = e.call(this, t, n, o)).props = {content: {width: 0}}, r.overflow = !1, t) {
        ...
        return pn(i, [{
            ...
            key: "repositionX", value: function (t) {
                var e, i, n = this.parent.width, o = this.conversion.toScreen(this.data.start),
            ...
            key: "_repaintDragLeft", value: function () {
            ...
            key: "_repaintDragRight", value: function () {
    ...
    var Op = function (t) {
        ...
        return pn(i, [{
            ...
            key: "repositionY", value: function (t) {
    ...
    }(), Pp = xi.every, Ap = po("every");
    xt({target: "Array", proto: !0, forced: !Ap}, {
        every: function (t) {
            return Pp(this, t, arguments.length > 1 ? arguments[1] : void 0)
        }
    });
    var Lp = Pn("Array").every, Ip = Array.prototype, Np = function (t) {
        var e = t.every;
    ...
    var jp = function (t) {
        ...
        function i(t, n, o) {
            var r;
            un(this, i);
            var s = Fo({}, {fitOnDoubleClick: !0}, o, {editable: !1});
        ...
        return pn(i, [{
            ...
            key: "redraw", value: function (t) {
                var e, i, n, o, r, s, a, l,
                    h = [co(e = this._createDomElement).call(e, this), co(i = this._appendDomElement).call(i, this), co(n = this._updateDirtyDomComponents).call(n, this), co(o = function () {
            ...
            key: "repositionStype", value: function (t, e) {
                this.dom.line.style.display = "block", this.dom.dot.style.display = "block";
                var i = this.dom.line.offsetWidth, n = this.dom.dot.offsetWidth;
                if (e) {
                    var o = i + t + (e - t) / 2, r = o - n / 2, s = this.options.rtl ? -1 * o : o,
                    ...
                    var l = this.options.rtl ? -1 * t : t, h = this.options.rtl ? -1 * (t - n / 2) : t - n / 2;
                    this.dom.line.style.transform = "translateX(".concat(l, "px)"), this.dom.dot.style.transform = "translateX(".concat(h, "px)")
                }
            }
        }, {
            key: "repositionXWithoutRanges", value: function (t, e) {
            ...
            key: "repositionXWithRanges", value: function (t, e) {
            ...
            key: "_onDoubleClick", value: function () {
                this._fit()
            }
        }, {
            key: "_setupRange", value: function () {
            ...
            key: "_getUiItems", value: function () {
                var t, e = this;
            ...
            key: "_getDomComponentsSizes", value: function () {
                ...
                }, t.line = {width: this.dom.line.offsetWidth}), t
            }
        }, {
            key: "_updateDomComponentsSizes", value: function (t) {
            ...
            key: "_isStipeVisible", value: function () {
                return this.minWidth >= this.width || !this.data.end
            }
        }, {
            key: "_getFitRange", value: function () {
            ...
            key: "_fit", value: function () {
                if (this.emitter) {
                    var t = this._getFitRange(), e = t.fitStart, i = t.fitEnd,
    ...
    var Gp = "__ungrouped__", Bp = function () {
        function t(e) {
            un(this, t), this.itemSet = e, this.groups = {}, this.cache = {}, this.cache[-1] = []
        }

        return pn(t, [{
            key: "createClusterItem", value: function (t, e, i) {
                return new jp(t, e, i)
            }
        }, {
            key: "setItems", value: function (t, e) {
            ...
            key: "getClusters", value: function (t, e, i) {
                var n = "boolean" == typeof i ? {} : i, o = n.maxItems, r = n.clusterCriteria;
                r || (r = function () {
                    return !0
                }), o = o || 1;
                var s = -1, a = 0;
                ...
                var h = this.cache[s];
                if (!h) {
                    for (var u in h = [], this.groups) if (this.groups.hasOwnProperty(u)) for (var d = this.groups[u], c = d.length, p = 0; p < c;) {
            ...
            key: "_filterData", value: function () {
                var t = {};
                this.groups = t;
                for (var e = 0, i = nr(this.items); e < i.length; e++) {
                    var n = i[e], o = n.parent ? n.parent.groupId : "", r = t[o];
            ...
            key: "_getClusterForItems", value: function (t, e, i, n) {
                var o, r, s = eo(o = i || []).call(o, (function (t) {
                    var e;
                    return {
                        cluster: t, itemsIds: new Fh(eo(e = t.data.uiItems).call(e, (function (t) {
                            return t.id
                        })))
                    }
                }));
                ...
                var u = n.titleTemplate || "",
                    ...
                    c = u.replace(/{count}/, t.length), p = '<div title="' + c + '">' + t.length + "</div>",
                    f = Fo({}, n, this.itemSet.options), m = {
                        content: p,
                        title: c,
                        group: e,
                        uiItems: t,
            ...
            key: "_dropLevelsCache", value: function () {
    ...
    var Xp = "__ungrouped__", qp = "__background__", Zp = function (t) {
        Ql(i, t);
        var e = Up(i);
        ...
        return pn(i, [{
            key: "_create", value: function () {
                var t, e, i, n, o, r, s, a, l, h, u, d, c, p, f, m = this, v = document.createElement("div");
            ...
            key: "setOptions", value: function (t) {
                ...
                if (t) {
                    ...
                    })), t.cluster ? (Fo(this.options, {cluster: t.cluster}), this.clusterGenerator || (this.clusterGenerator = new Bp(this)), this.clusterGenerator.setItems(this.items, {applyOnChangedLevel: !1}), this.markDirty({
                        refreshItems: !0,
                        restackGroups: !0
            ...
            key: "markDirty", value: function (t) {
            ...
            key: "setPopupTimer", value: function (t) {
            ...
            key: "clearPopupTimer", value: function () {
            ...
            key: "setSelection", value: function (t) {
                ...
                try {
                    for (n.s(); !(i = n.n()).done;) {
                        var o = i.value, r = this.getItemById(o);
                        r && r.unselect()
                    }
                } catch (t) {
                    n.e(t)
                ...
                try {
                    for (a.s(); !(s = a.n()).done;) {
                        var l = s.value, h = this.getItemById(l);
                        h && h.select()
                    }
                } catch (t) {
                    a.e(t)
            ...
            key: "getVisibleItems", value: function () {
                ...
                for (var o in this.groups) if (this.groups.hasOwnProperty(o)) {
                    var r, s = this.groups[o], a = Wp(s.isVisible ? s.visibleItems : []);
                    try {
                        for (a.s(); !(r = a.n()).done;) {
                            var l = r.value;
            ...
            key: "getItemById", value: function (t) {
                var e;
            ...
            key: "_deselect", value: function (t) {
            ...
            key: "redraw", value: function () {
                var t = this, e = this.options.margin, i = this.body.range, n = Zd.option.asSize, o = this.options,
                    r = o.orientation.item, s = !1, a = this.dom.frame;
                ...
                var l = i.end - i.start, h = l != this.lastVisibleInterval || this.props.width != this.props.lastWidth,
                    u = i.start != this.lastRangeStart, d = o.stack != this.lastStack,
                    c = o.stackSubgroups != this.lastStackSubgroups, p = h || u || d || c;
                ...
                var f = this._firstGroup(), m = {item: e.item, axis: e.axis},
                    v = {item: e.item, axis: e.item.vertical / 2}, g = 0, y = e.axis + e.item.vertical;
            ...
            key: "_firstGroup", value: function () {
            ...
            key: "_updateUngrouped", value: function () {
                var t, e, i = this.groups[Xp];
                if (this.groupsData) {
                    if (i) for (e in i.dispose(), delete this.groups[Xp], this.items) if (this.items.hasOwnProperty(e)) {
                        (t = this.items[e]).parent && t.parent.remove(t);
                        var n = this.getGroupId(t.data), o = this.groups[n];
                        o && o.add(t) || t.hide()
                    }
                } else if (!i) {
            ...
            key: "setGroups", value: function (t) {
                var e, i = this;
            ...
            key: "_onRemove", value: function (t) {
                var e = 0, i = this;
                bo(t).call(t, (function (t) {
                    var n = i.items[t];
                    n && (e++, i._removeItem(n))
            ...
            key: "_order", value: function () {
                bo(Zd).call(Zd, this.groups, (function (t) {
                    t.order()
                }))
            }
        }, {
            key: "_onUpdateGroups", value: function (t) {
                this._onAddGroups(t)
            }
        }, {
            key: "_onAddGroups", value: function (t) {
                var e = this;
                bo(t).call(t, (function (t) {
                    var i = e.groupsData.get(t), n = e.groups[t];
                    if (n) n.setData(i); else {
                        if (t == Xp || t == qp) throw new Error("Illegal group id. ".concat(t, " is a reserved id."));
                        var o = Or(e.options);
                        for (var r in Zd.extend(o, {height: null}), n = new vp(t, i, e), e.groups[t] = n, e.items) if (e.items.hasOwnProperty(r)) {
                            var s = e.items[r];
            ...
            key: "_onRemoveGroups", value: function (t) {
                var e = this;
                bo(t).call(t, (function (t) {
                    var i = e.groups[t];
            ...
            key: "_orderGroups", value: function () {
                if (this.groupsData) {
            ...
            key: "_orderNestedGroups", value: function (t) {
                var e = this;
            ...
            key: "_addItem", value: function (t) {
                this.items[t.id] = t;
                var e = this.getGroupId(t.data), i = this.groups[e];
                i ? i && i.data && i.data.showNested && (t.groupShowing = !0) : t.groupShowing = !1, i && i.add(t)
            }
        }, {
            key: "_updateItem", value: function (t, e) {
                t.setData(e);
                var i = this.getGroupId(t.data), n = this.groups[i];
                n ? n && n.data && n.data.showNested && (t.groupShowing = !0) : t.groupShowing = !1
            }
        }, {
            key: "_removeItem", value: function (t) {
                var e, i;
                t.hide(), delete this.items[t.id];
                var n = kr(e = this.selection).call(e, t.id);
                -1 != n && Ao(i = this.selection).call(i, n, 1), t.parent && t.parent.remove(t), null != this.popup && this.popup.hide()
            }
        }, {
            key: "_constructByEndArray", value: function (t) {
            ...
            key: "_getGroupIndex", value: function (t) {
            ...
            key: "_onDragStart", value: function (t) {
                ...
                if (!this.touchParams.itemIsDragging) {
                    var i, n = this.touchParams.item || null, o = this;
                    if (n && (n.selected || this.options.itemsAlwaysDraggable.item)) {
                        ...
                        var r = this.touchParams.dragLeftItem, s = this.touchParams.dragRightItem;
                        if (this.touchParams.itemIsDragging = !0, this.touchParams.selectedItem = n, r) i = {
                            ...
                            this.touchParams.itemProps = eo(l).call(l, (function (i) {
                                var n = o.items[i], r = o._getGroupIndex(n.data.group);
                                return {
                                    item: n,
                                    initialX: t.center.x,
                                    groupOffset: a - r,
            ...
            key: "_onDragStartAddItem", value: function (t) {
                var e = this.options.snap || null, i = this.dom.frame.getBoundingClientRect(),
                    n = this.options.rtl ? i.right - t.center.x + 10 : t.center.x - i.left - 10,
                    o = this.body.util.toTime(n), r = this.body.util.getScale(), s = this.body.util.getStep(),
                    a = e ? e(o, r, s) : o, l = {type: "range", start: a, end: a, content: "new item"}, h = Su();
            ...
            key: "_onDrag", value: function (t) {
                ...
                if (null != this.popup && this.options.showTooltips && !this.popup.hidden) {
                    var i = this.body.dom.centerContainer, n = i.getBoundingClientRect();
                    this.popup.setPosition(t.center.x - n.left + i.offsetLeft, t.center.y - n.top + i.offsetTop), this.popup.show()
                }
                if (this.touchParams.itemProps) {
                    var o;
                    t.stopPropagation();
                    var r = this, s = this.options.snap || null, a = this.body.dom.root.offsetLeft,
                        l = this.options.rtl ? a + this.body.domProps.right.width : a + this.body.domProps.left.width,
                        h = this.body.util.getScale(), u = this.body.util.getStep(), d = this.touchParams.selectedItem,
                    ...
                    bo(o = this.touchParams.itemProps).call(o, (function (i) {
                        ...
                        if (null == i.item.editable || i.item.editable.updateTime || i.item.editable.updateGroup || r.options.editable.overrideItems) {
                            if ((e.options.editable.overrideItems || null == d.editable) && e.options.editable.updateTime || !e.options.editable.overrideItems && null != d.editable && d.editable.updateTime) if (i.dragLeft) e.options.rtl ? null != y.end && (a = Zd.convert(i.data.end, "Date"), m = new Date(a.valueOf() + n), y.end = s ? s(m, h, u) : m) : null != y.start && (o = Zd.convert(i.data.start, "Date"), f = new Date(o.valueOf() + n), y.start = s ? s(f, h, u) : f); else if (i.dragRight) e.options.rtl ? null != y.start && (o = Zd.convert(i.data.start, "Date"), f = new Date(o.valueOf() + n), y.start = s ? s(f, h, u) : f) : null != y.end && (a = Zd.convert(i.data.end, "Date"), m = new Date(a.valueOf() + n), y.end = s ? s(m, h, u) : m); else if (null != y.start) if (o = Zd.convert(i.data.start, "Date").valueOf(), f = new Date(o + n), null != y.end) {
            ...
            key: "_moveToGroup", value: function (t, e) {
                var i = this.groups[e];
            ...
            key: "_onDragEnd", value: function (t) {
                ...
                if (this.touchParams.itemIsDragging = !1, this.touchParams.itemProps) {
                    t.stopPropagation();
                    var i = this, n = this.touchParams.itemProps;
            ...
            key: "_onGroupClick", value: function (t) {
                var e = this, i = this.groupFromTarget(t);
                Hr((function () {
                    e.toggleGroupShowNested(i)
                }), 1)
            }
        }, {
            key: "toggleGroupShowNested", value: function (t) {
            ...
            key: "toggleGroupDragClassName", value: function (t) {
                t.dom.label.classList.toggle("vis-group-is-dragging"), t.dom.foreground.classList.toggle("vis-group-is-dragging")
            }
        }, {
            key: "_onGroupDragStart", value: function (t) {
                this.groupTouchParams.isDragging || this.options.groupEditable.order && (this.groupTouchParams.group = this.groupFromTarget(t), this.groupTouchParams.group && (t.stopPropagation(), this.groupTouchParams.isDragging = !0, this.toggleGroupDragClassName(this.groupTouchParams.group), this.groupTouchParams.originalOrder = this.groupsData.getIds({order: this.options.groupOrder})))
            }
        }, {
            key: "_onGroupDrag", value: function (t) {
                if (this.options.groupEditable.order && this.groupTouchParams.group) {
                    t.stopPropagation();
                    var e = this.groupsData.getDataSet(), i = this.groupFromTarget(t);
                    if (i && i.height != this.groupTouchParams.group.height) {
                        var n = i.top < this.groupTouchParams.group.top, o = t.center ? t.center.y : t.clientY,
                            r = i.dom.foreground.getBoundingClientRect(), s = this.groupTouchParams.group.height;
                        if (n) {
                            if (r.top + s < o) return
                        } else {
                            var a = i.height;
                    ...
                    if (i && i != this.groupTouchParams.group) {
                        var l = e.get(i.groupId), h = e.get(this.groupTouchParams.group.groupId);
                        h && l && (this.options.groupOrderSwap(h, l, e), e.update(h), e.update(l));
                        var u = e.getIds({order: this.options.groupOrder});
                        if (!Zd.equalArray(u, this.groupTouchParams.originalOrder)) for (var d = this.groupTouchParams.originalOrder, c = this.groupTouchParams.group.groupId, p = Math.min(d.length, u.length), f = 0, m = 0, v = 0; f < p;) {
                            for (; f + m < p && f + v < p && u[f + m] == d[f + v];) f++;
                            if (f + m >= p) break;
                            if (u[f + m] == c) m = 1; else if (d[f + v] == c) v = 1; else {
                                var g = kr(u).call(u, d[f + v]), y = e.get(u[f + m]), b = e.get(d[f + v]);
            ...
            key: "_onGroupDragEnd", value: function (t) {
                if (this.groupTouchParams.isDragging = !1, this.options.groupEditable.order && this.groupTouchParams.group) {
                    t.stopPropagation();
                    var e = this, i = e.groupTouchParams.group.groupId, n = e.groupsData.getDataSet(),
                        o = Zd.extend({}, n.get(i));
                    e.options.onMoveGroup(o, (function (t) {
                        if (t) t[n._idProp] = i, n.update(t); else {
                            var o = n.getIds({order: e.options.groupOrder});
                            if (!Zd.equalArray(o, e.groupTouchParams.originalOrder)) for (var r = e.groupTouchParams.originalOrder, s = Math.min(r.length, o.length), a = 0; a < s;) {
                                for (; a < s && o[a] == r[a];) a++;
                                if (a >= s) break;
                                var l = kr(o).call(o, r[a]), h = n.get(o[a]), u = n.get(r[a]);
            ...
            key: "_onSelectItem", value: function (t) {
                if (this.options.selectable) {
                    ...
                    if (e || i) this._onMultiSelectItem(t); else {
                        var n = this.getSelection(), o = this.itemFromTarget(t), r = o && o.selectable ? [o.id] : [];
                        this.setSelection(r);
            ...
            key: "_onMouseOver", value: function (t) {
                ...
                if (e && e !== this.itemFromRelatedTarget(t)) {
                    ...
                    if (this.options.showTooltips && i) {
                        ...
                        var n = this.body.dom.centerContainer, o = n.getBoundingClientRect();
            ...
            key: "_onMouseOut", value: function (t) {
                var e = this.itemFromTarget(t);
            ...
            key: "_onMouseMove", value: function (t) {
                if (this.itemFromTarget(t) && (null != this.popupTimer && this.setPopupTimer(this.popup), this.options.showTooltips && this.options.tooltip.followMouse && this.popup && !this.popup.hidden)) {
                    var e = this.body.dom.centerContainer, i = e.getBoundingClientRect();
            ...
            key: "_onUpdateItem", value: function (t) {
            ...
            key: "_onDropObjectOnItem", value: function (t) {
                var e = this.itemFromTarget(t), i = JSON.parse(t.dataTransfer.getData("text"));
                this.options.onDropObjectOnItem(i, e)
            }
        }, {
            key: "_onAddItem", value: function (t) {
                if (this.options.selectable && this.options.editable.add) {
                    var e, i, n = this, o = this.options.snap || null, r = this.dom.frame.getBoundingClientRect(),
                        s = this.options.rtl ? r.right - t.center.x : t.center.x - r.left, a = this.body.util.toTime(s),
                        l = this.body.util.getScale(), h = this.body.util.getStep();
            ...
            key: "_onMultiSelectItem", value: function (t) {
                var e = this;
                if (this.options.selectable) {
                    ...
                    if (n) {
                        ...
                        if ((t.srcEvent && t.srcEvent.shiftKey || !1 || this.options.sequentialSelection) && this.options.multiselect) {
                            var r = this.itemsData.get(n.id).group, s = void 0;
                            ...
                            if (!this.options.multiselectPerGroup || s == r) for (var l in o = [], this.items) if (this.items.hasOwnProperty(l)) {
                                var h = this.items[l], u = h.data.start, d = void 0 !== h.data.end ? h.data.end : u;
                                !(u >= a.min && d <= a.max) || this.options.multiselectPerGroup && s != this.itemsData.get(h.id).group || h instanceof Op || o.push(h.id)
                            }
                        } else {
                            var c = kr(o).call(o, n.id);
                            -1 == c ? o.push(n.id) : Ao(o).call(o, c, 1)
                        }
            ...
            key: "itemFromElement", value: function (t) {
                for (var e = t; e;) {
            ...
            key: "itemFromTarget", value: function (t) {
                return this.itemFromElement(t.target)
            }
        }, {
            key: "itemFromRelatedTarget", value: function (t) {
                return this.itemFromElement(t.relatedTarget)
            }
        }, {
            key: "groupFromTarget", value: function (t) {
                ...
                for (var n = 0; n < i.length; n++) {
                    var o = i[n], r = this.groups[o], s = r.dom.foreground, a = s.getBoundingClientRect();
            ...
            key: "_cloneItemData", value: function (t, e) {
                var i = Zd.extend({}, t);
            ...
            key: "_clusterItems", value: function () {
            ...
            key: "_detachAllClusters", value: function () {
            ...
            key: "_updateClusters", value: function (t) {
                if (this.clusters && this.clusters.length) {
                    var e, i, n = new Fh(eo(t).call(t, (function (t) {
                        return t.id
                    }))), o = !1, r = Wp(Qo(e = this.clusters).call(e, (function (t) {
                        return !n.has(t.id)
                    })));
                    try {
                        for (r.s(); !(i = r.n()).done;) {
                            var s, a, l = i.value, h = kr(s = this.selection).call(s, l.id);
            ...
            key: "_getItemRange", value: function (t) {
                var e = null, i = null;
            ...
            key: "itemSetFromTarget", value: function (t) {
                for (var e = t.target; e;) {
    ...
    Zp.types = {background: Op, box: xp, range: Tp, point: Sp}, Zp.prototype._onAdd = Zp.prototype._onUpdate;
    var $p, Kp = !1, Jp = "background: #FFeeee; color: #dd0000", Qp = function () {
        function t() {
            un(this, t)
        }
        ...
        return pn(t, null, [{
            ...
            key: "getSuggestion", value: function (e, i, n) {
                var o, r = t.findInOptions(e, i, n, !1), s = t.findInOptions(e, $p, [], !0);
            ...
            key: "findInOptions", value: function (e, i, n) {
                ...
                for (var u in i) {
                    ...
                    if (void 0 !== i[u].__type__ && !0 === o) {
                        ...
                        var p;
                        -1 !== kr(p = u.toLowerCase()).call(p, l) && (h = u), r > (d = t.levenshteinDistance(e, u)) && (s = u, a = Zd.copyArray(n), r = d)
                    }
                }
                return {closestMatch: s, path: a, distance: r, indexMatch: h}
            }
    ...
    }(), tf = "string", ef = "boolean", nf = "number", of = "array", rf = "date", sf = "object", af = "moment", lf = {
        configure: {
            enabled: {boolean: ef},
            filter: {boolean: ef, function: "function"},
            container: {dom: "dom"},
            __type__: {object: sf, boolean: ef, function: "function"}
        },
        align: {string: tf},
        alignCurrentTime: {string: tf, undefined: "undefined"},
        rtl: {boolean: ef, undefined: "undefined"},
        rollingMode: {follow: {boolean: ef}, offset: {number: nf, undefined: "undefined"}, __type__: {object: sf}},
        onTimeout: {timeoutMs: {number: nf}, callback: {function: "function"}, __type__: {object: sf}},
        verticalScroll: {boolean: ef, undefined: "undefined"},
        horizontalScroll: {boolean: ef, undefined: "undefined"},
        autoResize: {boolean: ef},
        throttleRedraw: {number: nf},
        clickToUse: {boolean: ef},
        dataAttributes: {string: tf, array: of},
        editable: {
            add: {boolean: ef, undefined: "undefined"},
            remove: {boolean: ef, undefined: "undefined"},
            updateGroup: {boolean: ef, undefined: "undefined"},
            updateTime: {boolean: ef, undefined: "undefined"},
            overrideItems: {boolean: ef, undefined: "undefined"},
            __type__: {boolean: ef, object: sf}
        },
        end: {number: nf, date: rf, string: tf, moment: af},
        format: {
            minorLabels: {
                millisecond: {string: tf, undefined: "undefined"},
                second: {string: tf, undefined: "undefined"},
                minute: {string: tf, undefined: "undefined"},
                hour: {string: tf, undefined: "undefined"},
                weekday: {string: tf, undefined: "undefined"},
                day: {string: tf, undefined: "undefined"},
                week: {string: tf, undefined: "undefined"},
                month: {string: tf, undefined: "undefined"},
                year: {string: tf, undefined: "undefined"},
                __type__: {object: sf, function: "function"}
            },
            majorLabels: {
                millisecond: {string: tf, undefined: "undefined"},
                second: {string: tf, undefined: "undefined"},
        ...
        groupHeightMode: {string: tf},
        groupOrder: {string: tf, function: "function"},
        groupEditable: {
            add: {boolean: ef, undefined: "undefined"},
            remove: {boolean: ef, undefined: "undefined"},
            order: {boolean: ef, undefined: "undefined"},
            __type__: {boolean: ef, object: sf}
        },
        groupOrderSwap: {function: "function"},
        height: {string: tf, number: nf},
        hiddenDates: {
            start: {date: rf, number: nf, string: tf, moment: af},
            end: {date: rf, number: nf, string: tf, moment: af},
            repeat: {string: tf},
            __type__: {object: sf, array: of}
        },
        itemsAlwaysDraggable: {
            item: {boolean: ef, undefined: "undefined"},
            range: {boolean: ef, undefined: "undefined"},
            __type__: {boolean: ef, object: sf}
        },
        limitSize: {boolean: ef},
        locale: {string: tf},
        locales: {__any__: {any: "any"}, __type__: {object: sf}},
        longSelectPressTime: {number: nf},
        margin: {
            axis: {number: nf},
            item: {
                horizontal: {number: nf, undefined: "undefined"},
                vertical: {number: nf, undefined: "undefined"},
                __type__: {object: sf, number: nf}
            },
            __type__: {object: sf, number: nf}
        },
        max: {date: rf, number: nf, string: tf, moment: af},
        maxHeight: {number: nf, string: tf},
        maxMinorChars: {number: nf},
        min: {date: rf, number: nf, string: tf, moment: af},
        minHeight: {number: nf, string: tf},
        moveable: {boolean: ef},
        multiselect: {boolean: ef},
        multiselectPerGroup: {boolean: ef},
        ...
        orientation: {
            axis: {string: tf, undefined: "undefined"},
            item: {string: tf, undefined: "undefined"},
            __type__: {string: tf, object: sf}
        },
        selectable: {boolean: ef},
        sequentialSelection: {boolean: ef},
        showCurrentTime: {boolean: ef},
        showMajorLabels: {boolean: ef},
        showMinorLabels: {boolean: ef},
        showWeekScale: {boolean: ef},
        stack: {boolean: ef},
        stackSubgroups: {boolean: ef},
        cluster: {
            maxItems: {number: nf, undefined: "undefined"},
            titleTemplate: {string: tf, undefined: "undefined"},
            clusterCriteria: {function: "function", undefined: "undefined"},
            showStipes: {boolean: ef, undefined: "undefined"},
            fitOnDoubleClick: {boolean: ef, undefined: "undefined"},
            __type__: {boolean: ef, object: sf}
        },
        ...
        visibleFrameTemplate: {string: tf, function: "function"},
        showTooltips: {boolean: ef},
        tooltip: {
            followMouse: {boolean: ef},
            overflowMethod: {string: ["cap", "flip", "none"]},
            delay: {number: nf},
            template: {function: "function"},
            __type__: {object: sf}
        },
        tooltipOnItemUpdateTime: {template: {function: "function"}, __type__: {boolean: ef, object: sf}},
        timeAxis: {
            scale: {string: tf, undefined: "undefined"},
            step: {number: nf, undefined: "undefined"},
            __type__: {object: sf}
        },
        type: {string: tf},
        width: {string: tf, number: nf},
        preferZoom: {boolean: ef},
        zoomable: {boolean: ef},
        zoomKey: {string: ["ctrlKey", "altKey", "shiftKey", "metaKey", ""]},
        zoomFriction: {number: nf},
        zoomMax: {number: nf},
        zoomMin: {number: nf},
        xss: {
            disabled: {boolean: ef},
            filterOptions: {__any__: {any: "any"}, __type__: {object: sf}},
            __type__: {object: sf}
        },
        __type__: {object: sf}
    }, hf = {
        ...
        return pn(t, [{
            ...
            key: "_setColor", value: function (t) {
                ...
                var i = Zd.RGBToHSV(t.r, t.g, t.b), n = 2 * Math.PI, o = this.r * i.s,
                    r = this.centerCoordinates.x + o * Math.sin(n * i.h),
                    s = this.centerCoordinates.y + o * Math.cos(n * i.h);
                this.colorPickerSelector.style.left = r - .5 * this.colorPickerSelector.clientWidth + "px", this.colorPickerSelector.style.top = s - .5 * this.colorPickerSelector.clientHeight + "px", this._updatePicker(t)
            }
            ...
            key: "_updatePicker", value: function () {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this.color,
                    e = Zd.RGBToHSV(t.r, t.g, t.b), i = this.colorPickerCanvas.getContext("2d");
                void 0 === this.pixelRation && (this.pixelRatio = (window.devicePixelRatio || 1) / (i.webkitBackingStorePixelRatio || i.mozBackingStorePixelRatio || i.msBackingStorePixelRatio || i.oBackingStorePixelRatio || i.backingStorePixelRatio || 1)), i.setTransform(this.pixelRatio, 0, 0, this.pixelRatio, 0, 0);
                var n = this.colorPickerCanvas.clientWidth, o = this.colorPickerCanvas.clientHeight;
                i.clearRect(0, 0, n, o), i.putImageData(this.hueCircle, 0, 0), i.fillStyle = "rgba(0,0,0," + (1 - e.v) + ")", i.circle(this.centerCoordinates.x, this.centerCoordinates.y, this.r), Br(i).call(i), this.brightnessRange.value = 100 * e.v, this.opacityRange.value = 100 * t.a, this.initialColorDiv.style.backgroundColor = "rgba(" + this.initialColor.r + "," + this.initialColor.g + "," + this.initialColor.b + "," + this.initialColor.a + ")", this.newColorDiv.style.backgroundColor = "rgba(" + this.color.r + "," + this.color.g + "," + this.color.b + "," + this.color.a + ")"
            }
            ...
            key: "_bindHammer", value: function () {
                var t = this;
                this.drag = {}, this.pinch = {}, this.hammer = new Dc(this.colorPickerCanvas), this.hammer.get("pinch").set({enable: !0}), Sc(this.hammer, (function (e) {
                    t._moveSelector(e)
                })), this.hammer.on("tap", (function (e) {
                    t._moveSelector(e)
                })), this.hammer.on("panstart", (function (e) {
            ...
            key: "_generateHueCircle", value: function () {
                if (!1 === this.generated) {
                    ...
                    t.clearRect(0, 0, r, s), this.centerCoordinates = {x: .5 * r, y: .5 * s}, this.r = .49 * r;
                    var a, l = 2 * Math.PI / 360, h = 1 / this.r;
                    for (n = 0; n < 360; n++) for (o = 0; o < this.r; o++) e = this.centerCoordinates.x + o * Math.sin(l * n), i = this.centerCoordinates.y + o * Math.cos(l * n), a = Zd.HSVToRGB(.002777777777777778 * n, o * h, 1), t.fillStyle = "rgb(" + a.r + "," + a.g + "," + a.b + ")", t.fillRect(e - .5, i - .5, 2, 2);
                    t.strokeStyle = "rgba(0,0,0,1)", t.circle(this.centerCoordinates.x, this.centerCoordinates.y, this.r), t.stroke(), this.hueCircle = t.getImageData(0, 0, r, s)
                }
                this.generated = !0
            }
            ...
            key: "_moveSelector", value: function (t) {
                ...
                var c = l / (2 * Math.PI);
                c = c < 0 ? c + 1 : c;
                var p = h / this.r, f = Zd.RGBToHSV(this.color.r, this.color.g, this.color.b);
                f.h = c, f.s = p;
        ...
        return pn(t, [{
            ...
            key: "_handleObject", value: function (t) {
                ...
                for (var s in t) if (t.hasOwnProperty(s)) {
                    n = !0;
                    var a = t[s], l = Zd.copyAndExtendArray(e, s);
                    if ("function" == typeof o && !1 === (n = o(s, e)) && !$n(a) && "string" != typeof a && "boolean" != typeof a && a instanceof Object && (this.allowCreation = !1, n = this._handleObject(a, l, !0), this.allowCreation = !1 === i), !1 !== n) {
                        r = !0;
                        var h = this._getValue(l);
                        if ($n(a)) this._handleArray(a, h, l); else if ("string" == typeof a) this._makeTextInput(a, h, l); else if ("boolean" == typeof a) this._makeCheckbox(a, h, l); else if (a instanceof Object) {
                            var u = !0;
                            if (-1 !== kr(e).call(e, "physics") && this.moduleOptions.physics.solver !== s && (u = !1), !0 === u) if (void 0 !== a.enabled) {
                                var d = Zd.copyAndExtendArray(l, "enabled"), c = this._getValue(d);
                                if (!0 === c) {
                                    var p = this._makeLabel(s, l, !0);
                                    this._makeItem(l, p), r = this._handleObject(a, l) || r
    ...
    var ff = function (t) {
        ...
        function i(t, n, o, r) {
            ...
            if (p.options.loadingScreenTemplate) {
                var b, _ = co(b = p.options.loadingScreenTemplate).call(b, Zl(p)), w = _(p.dom.loadingScreen);
            ...
            return p.dom.loadingScreen.appendChild(y), p.components = [], p.body = {
                ...
                if (null != m.itemsData) {
                    if (!m.initialFitDone && !m.options.rollingMode) if (m.initialFitDone = !0, null != m.options.start || null != m.options.end) {
        ...
        return pn(i, [{
            ...
            key: "setSelection", value: function (t, e) {
            ...
            key: "getItemRange", value: function () {
                var t = this, e = this.getDataRange(), i = null !== e.min ? e.min.valueOf() : null,
                    n = null !== e.max ? e.max.valueOf() : null, o = null, r = null;
                if (null != i && null != n) {
                    var s = n - i;
                    s <= 0 && (s = 10);
                    var a = s / this.props.center.width, l = {}, h = 0;
                    ...
                    if (bo(Zd).call(Zd, this.itemSet.items, (function (e) {
                        ...
                        var c = o.getWidthLeft() + 10, p = r.getWidthRight() + 10, f = this.props.center.width - c - p;
            ...
            key: "getEventProperties", value: function (t) {
                var e = t.center ? t.center.x : t.clientX, i = t.center ? t.center.y : t.clientY,
                    ...
                    o = this.options.rtl ? n.right - e : e - n.left, r = i - n.top, s = this.itemSet.itemFromTarget(t),
                    a = this.itemSet.groupFromTarget(t), l = qc.customTimeFromTarget(t),
                    h = this.itemSet.options.snap || null, u = this.body.util.getScale(), d = this.body.util.getStep(),
                    c = this._toTime(o), p = h ? h(c, u, d) : c, f = Zd.getTarget(t), m = null;
            ...
            key: "toggleRollingMode", value: function () {
            ...
            key: "_onFit", value: function (t) {
                var e = t.start, i = t.end, n = t.animation;
    ...
    function gf(t, e) {
        ...
        var i = t.options.rtl ? t.props.rightContainer.height : t.props.leftContainer.height, n = t.props.center.height,
            o = e.parent, r = o.top, s = !0, a = t.timeAxis.options.orientation.axis, l = function () {
                return "bottom" == a ? o.height - e.top - e.height : e.top
            }, h = -1 * t._getScrollTop(), u = r + l(), d = e.height;
    ...
    var yf = function () {
        ...
        return pn(t, [{
            key: "setCharHeight", value: function (t) {
            ...
            key: "determineScale", value: function () {
            ...
            key: "getFirstMajor", value: function () {
            ...
            key: "followScale", value: function (t) {
                var e = this.minorStepIdx, i = this._start, n = this._end, o = this, r = function () {
                    o.magnitudefactor *= 2
                }, s = function () {
                    o.magnitudefactor /= 2
                };
            ...
            key: "convertValue", value: function (t) {
                return this.containerHeight - (t - this._start) * this.scale
            }
        }, {
            key: "screenToValue", value: function (t) {
    ...
    var kf = function (t) {
        ...
        return pn(i, [{
            ...
            key: "_redrawGroupIcons", value: function () {
                var t;
                Nl(this.svgElements);
                var e = this.options.iconWidth, i = 11.5;
            ...
            key: "_cleanupIcons", value: function () {
            ...
            key: "setRange", value: function (t, e) {
            ...
            key: "redraw", value: function () {
                ...
                if (0 === this.amountOfGroups || 0 === e) this.hide(); else {
                    ...
                    var n = this.props, o = this.dom.frame;
                    o.className = "vis-data-axis", this._calculateCharSize();
                    var r = this.options.orientation, s = this.options.showMinorLabels,
                        a = this.options.showMajorLabels, l = this.body.dom.backgroundHorizontal.offsetWidth;
            ...
            key: "_redrawLabels", value: function () {
                var t = this, e = !1;
                Nl(this.DOMelements.lines), Nl(this.DOMelements.labels);
                var i = this.options.orientation, n = null != this.options[i].range ? this.options[i].range : {},
                    o = !0;
            ...
            key: "_redrawLabel", value: function (t, e, i, n, o) {
            ...
            key: "_redrawLine", value: function (t, e, i, n, o) {
                if (!0 === this.master) {
            ...
            key: "_redrawTitle", value: function (t) {
            ...
            key: "_calculateCharSize", value: function () {
                ...
                if (!("majorCharHeight" in this.props)) {
                    var i = document.createTextNode("0"), n = document.createElement("div");
                ...
                if (!("titleCharHeight" in this.props)) {
                    var o = document.createTextNode("0"), r = document.createElement("div");
    ...
    xf.draw = function (t, e, i, n) {
        ...
        var s = .5 * o, a = Yl("rect", r.svgElements, r.svg);
        ...
        var l = Math.round(.3 * n), h = t.options.barChart.width / l, u = Math.round(.4 * o), d = Math.round(.75 * o),
        ...
        if (0 !== d) for (iu(h).call(h, (function (t, e) {
            ...
            var c = null != (s = i.groups[h[a].groupId]).options.barChart.minWidth ? s.options.barChart.minWidth : .1 * s.options.barChart.width,
                p = 0;
            if (void 0 === u[o = h[a].screen_x]) a + 1 < h.length && (n = Math.abs(h[a + 1].screen_x - o)), r = Sf._getSafeDrawData(n, s, c); else {
        ...
        var s, a, l = .5 * o, h = Yl("rect", r.svgElements, r.svg);
        ...
        if (1 == e.options.shaded.enabled) {
            var o, r = Number(n.svg.style.height.replace("px", "")), s = Yl("path", n.svgElements, n.svg), a = "L";
        ...
        if (this.dom.frame.parentNode) {
            ...
            var e = window.getComputedStyle(this.dom.frame).paddingTop, i = Number(e.replace("px", "")), n = i,
                o = this.options.iconSize, r = .75 * this.options.iconSize, s = i + .5 * r + 3;
    ...
    Ef.prototype = new tc, Ef.prototype._create = function () {
        ...
        if (null != this.itemsData) {
            var i = {}, n = this.itemsData.get(), o = this.itemsData.idProp, r = {};
            ...
            for (a = 0; a < n.length; a++) if (null == (h = (l = n[a]).group) && (h = Of), e || !t || l[o] === r[l[o]] || !u.hasOwnProperty(l[o])) {
        ...
        var e, i = this.body.range.end - this.body.range.start, n = i != this.lastVisibleInterval;
        ...
        if (1 == this.updateSVGheight ? (this.options.graphHeight != this.props.height + "px" && (this.options.graphHeight = this.props.height + "px", this.svg.style.height = this.props.height + "px"), this.updateSVGheight = !1) : this.svg.style.height = ("" + this.options.graphHeight).replace("px", "") + "px", 1 == t || 1 == n || 1 == this.abortedGraphUpdate || 1 == this.forceGraphUpdate) t = this._updateGraph() || t, this.forceGraphUpdate = !1, this.lastStart = this.body.range.start, this.svg.style.left = -this.props.width + "px"; else if (0 != this.lastStart) {
            var o = this.body.range.start - this.lastStart, r = this.body.range.end - this.body.range.start;
        ...
        if (Nl(this.svgElements), 0 != this.props.width && null != this.itemsData) {
            var t, e, i = {}, n = this.body.util.toGlobalTime(-this.body.domProps.root.width),
                o = this.body.util.toGlobalTime(2 * this.body.domProps.root.width), r = this._getSortedGroupIds();
            if (r.length > 0) {
                var s = {};
                ...
                for (Sf.draw(r, s, this.framework), e = 0; e < r.length; e++) if (t = this.groups[r[e]], s[r[e]].length > 0) switch (t.options.style) {
                    case"line":
        ...
        var i, n, o = !1, r = !1, s = !1, a = 1e9, l = 1e9, h = -1e9, u = -1e9;
        if (t.length > 0) {
        ...
        var i = this.yAxisLeft, n = Number(this.svg.style.height.replace("px", ""));
    ...
    var Pf = "string", Af = "boolean", Lf = "number", If = "date", Nf = "object", Ff = "moment", Rf = {
        configure: {
            enabled: {boolean: Af},
            filter: {boolean: Af, function: "function"},
            container: {dom: "dom"},
            __type__: {object: Nf, boolean: Af, function: "function"}
        },
        alignCurrentTime: {string: Pf, undefined: "undefined"},
        yAxisOrientation: {string: ["left", "right"]},
        defaultGroup: {string: Pf},
        sort: {boolean: Af},
        sampling: {boolean: Af},
        stack: {boolean: Af},
        graphHeight: {string: Pf, number: Lf},
        shaded: {
            enabled: {boolean: Af},
            orientation: {string: ["bottom", "top", "zero", "group"]},
            groupId: {object: Nf},
            __type__: {boolean: Af, object: Nf}
        },
        style: {string: ["line", "bar", "points"]},
        barChart: {
            width: {number: Lf},
            minWidth: {number: Lf},
            sideBySide: {boolean: Af},
        ...
        dataAxis: {
            showMinorLabels: {boolean: Af},
            showMajorLabels: {boolean: Af},
            showWeekScale: {boolean: Af},
            icons: {boolean: Af},
            width: {string: Pf, number: Lf},
            visible: {boolean: Af},
            alignZeros: {boolean: Af},
            left: {
                range: {
                    min: {number: Lf, undefined: "undefined"},
                    max: {number: Lf, undefined: "undefined"},
                    __type__: {object: Nf}
                },
                format: {function: "function"},
                title: {
                    text: {string: Pf, number: Lf, undefined: "undefined"},
                    style: {string: Pf, undefined: "undefined"},
                    __type__: {object: Nf}
                },
                __type__: {object: Nf}
            },
        ...
        groups: {visibility: {any: "any"}, __type__: {object: Nf}},
        autoResize: {boolean: Af},
        throttleRedraw: {number: Lf},
        clickToUse: {boolean: Af},
        end: {number: Lf, date: If, string: Pf, moment: Ff},
        format: {
            minorLabels: {
                millisecond: {string: Pf, undefined: "undefined"},
                second: {string: Pf, undefined: "undefined"},
                minute: {string: Pf, undefined: "undefined"},
                hour: {string: Pf, undefined: "undefined"},
                weekday: {string: Pf, undefined: "undefined"},
                day: {string: Pf, undefined: "undefined"},
                week: {string: Pf, undefined: "undefined"},
                month: {string: Pf, undefined: "undefined"},
                quarter: {string: Pf, undefined: "undefined"},
                year: {string: Pf, undefined: "undefined"},
                __type__: {object: Nf}
            },
            majorLabels: {
                millisecond: {string: Pf, undefined: "undefined"},
        ...
        moment: {function: "function"},
        height: {string: Pf, number: Lf},
        hiddenDates: {
            start: {date: If, number: Lf, string: Pf, moment: Ff},
            end: {date: If, number: Lf, string: Pf, moment: Ff},
            repeat: {string: Pf},
            __type__: {object: Nf, array: "array"}
        },
        locale: {string: Pf},
        locales: {__any__: {any: "any"}, __type__: {object: Nf}},
        max: {date: If, number: Lf, string: Pf, moment: Ff},
        maxHeight: {number: Lf, string: Pf},
        maxMinorChars: {number: Lf},
        min: {date: If, number: Lf, string: Pf, moment: Ff},
        minHeight: {number: Lf, string: Pf},
        moveable: {boolean: Af},
        multiselect: {boolean: Af},
        orientation: {string: Pf},
        showCurrentTime: {boolean: Af},
        showMajorLabels: {boolean: Af},
        showMinorLabels: {boolean: Af},
        showWeekScale: {boolean: Af},
        snap: {function: "function", null: "null"},
        start: {date: If, number: Lf, string: Pf, moment: Ff},
        timeAxis: {
            scale: {string: Pf, undefined: "undefined"},
            step: {number: Lf, undefined: "undefined"},
            __type__: {object: Nf}
        },
        width: {string: Pf, number: Lf},
        zoomable: {boolean: Af},
    ...
    function jf(t, e, i, n) {
        ...
        this.defaultOptions = {
            ...
            if (null != c.itemsData) {
                if (!c.initialFitDone && !c.options.rollingMode) if (c.initialFitDone = !0, null != c.options.start || null != c.options.end) {
    ...
    jf.prototype = new Zc, jf.prototype.setOptions = function (t) {
        ...
        if (e = t ? Hu("id", t) ? Vd(t) : Vd(new Yu(t)) : null, this.itemsData && this.itemsData.dispose(), this.itemsData = e, this.linegraph && this.linegraph.setItems(null != e ? e.rawDS : null), i) if (null != this.options.start || null != this.options.end) {
        ...
        for (var i in this.linegraph.groups) if (this.linegraph.groups.hasOwnProperty(i) && 1 == this.linegraph.groups[i].visible) for (var n = 0; n < this.linegraph.groups[i].itemsData.length; n++) {
            var o = this.linegraph.groups[i].itemsData[n], r = Zd.convert(o.x, "Date").valueOf();
        ...
        var e = t.center ? t.center.x : t.clientX, i = t.center ? t.center.y : t.clientY,
            n = e - Zd.getAbsoluteLeft(this.dom.centerContainer), o = i - Zd.getAbsoluteTop(this.dom.centerContainer),
            r = this._toTime(n), s = qc.customTimeFromTarget(t), a = Zd.getTarget(t), l = null;
        ...
        var h = [], u = this.linegraph.yAxisLeft, d = this.linegraph.yAxisRight;
    ...
    var zf = {
        ...
        TimeStep: Cc,
        components: {
            items: {Item: wp, BackgroundItem: Op, BoxItem: xp, ClusterItem: jp, PointItem: Sp, RangeItem: Tp},
            BackgroundGroup: yp,
            Component: tc,
            CurrentTime: Kc,
            CustomTime: qc,
    ...
    t.DOMutil = Bl, t.DataSet = Yu, t.DataView = ju, t.Graph2d = jf, t.Hammer = Dc, t.Queue = Nu, t.Timeline = ff, t.keycharm = Pc, t.moment = zu, t.timeline = zf, t.util = Il, Object.defineProperty(t, "__esModule", {value: !0})
}));
