...
(function($){
    $.widget("suwala.doubleScroll", {
		options: {
			...
			topScrollBarMarkup: '<div class="suwala-doubleScroll-scroll-wrapper" style="height: 20px;    margin-bottom: 15px;"><div class="suwala-doubleScroll-scroll" style="height: 20px;"></div></div>',
